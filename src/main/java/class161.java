public class class161 {
   ...
   final void method3545(int var1) {
      try {
         for(int var2 = 0; var2 < this.field6606 * -1845310689; ++var2) {
   ...
   public final int[] method3546(int var1, int var2) {
      try {
         if (this.field6606 * -1845310689 != this.field6605 * 1036538653) {
            if (this.field6606 * -1845310689 != 1) {
               class276 var3 = this.field6613[var1];
               if (var3 == null) {
                  this.field6612 = true;
                  if (this.field6610 * 851327335 >= -1845310689 * this.field6606) {
                     class276 var4 = (class276)this.field6611.method1278(975410288);
                     var3 = new class276(var1, var4.field10590 * -1113693749);
                     this.field6613[1544880463 * var4.field10589] = null;
                     var4.method545(-1460969981);
                  } else {
                     var3 = new class276(var1, this.field6610 * 851327335);
                     this.field6610 += -1189293481;
                  }
               ...
               return this.field6607[-1113693749 * var3.field10590];
            } else {
               this.field6612 = var1 != this.field6609 * -101586551;
               this.field6609 = var1 * 2063162553;
   ...
   public final int[][] method3547(int var1) {
      try {
         if (1036538653 * this.field6605 != -1845310689 * this.field6606) {
            throw new RuntimeException();
         } else {
            for(int var2 = 0; var2 < -1845310689 * this.field6606; ++var2) {
   ...
   class161(int var1, int var2, int var3) {
      this.field6605 = var2 * -1955264715;
      this.field6606 = var1 * -1906511649;
      this.field6607 = new int[-1845310689 * this.field6606][var3];
      this.field6613 = new class276[this.field6605 * 1036538653];
   }

   static void method3548(class744 var0, short var1) {
      try {
         var0.field3157[(var0.field3158 += 969361751) * -203050393 - 1] = class735.field3009.method4224(var0.field3161[var0.field3156 * 681479919 - 2], 245040087).field9003[var0.field3161[681479919 * var0.field3156 - 1]];
   ...
   static final void method3550(class744 var0, int var1) {
      try {
         ...
         if (-1673957995 * var3.field4273 >= 0 && 809765849 * var3.field4226 >= 0) {
            var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = var3.field4226 * 809765849;
         } else {
