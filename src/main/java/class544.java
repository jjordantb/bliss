public class class544 {
   ...
   public void method2353(int var1, int var2, int var3) {
      try {
         ...
         this.field3791 = var1 * (var2 - this.field3777) / 255 + this.field3777;
   ...
   public void method2354(class544 var1, int var2) {
      try {
         if (this.field3789) {
            this.field3777 = this.field3791;
         } else if (var1 != null && var1.field3789) {
            this.field3777 = 255 - var1.field3791;
         } else {
            this.field3777 = 0;
         }
   ...
   public boolean method2358(class848 var1, int var2, int var3, int var4) {
      try {
         if (this.field3793 != var2) {
            ...
            if (this.field3779 != null) {
               ...
               for(int var7 = 0; var7 < this.field3779.length; ++var7) {
                  ...
                  if (var8.method4699(this.field3787, this.field3778, this.field3792, this.field3793)) {
                     var6[this.field3775] = var8.field8330;
                     this.field3783[++this.field3775 - 1] = var8;
                  }
               }

               class519.method2666(var6, this.field3783, 0, this.field3775 - 1, -641027314);
            }
         ...
         if (this.field3784) {
            ...
            for(int var10 = this.field3775 - 1; var10 >= 0; --var10) {
         ...
         if (var3 != 0 && var1.method4807()) {
            if (this.field3771 == null && this.field3786 >= 0) {
   ...
   void method2359(class848 var1, int var2) {
      try {
         try {
            boolean var3 = class537.field3750.method3261(this.field3786, 581664063);
            if (var3) {
               var1.method4872(16777215, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F);
               class25 var4 = class25.method3454(class537.field3750, this.field3786, 0);
   ...
   void method2363(class848 var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, boolean var11, boolean var12, int var13, int var14) {
      try {
         ...
         if (this.field3771 == null) {
            ...
            if (this.field3770 != -1 && this.field3776 != 0) {
               class414 var16 = field3785.method4625(this.field3770, 434799685);
               if (this.field3780 == null && field3785.method4621(this.field3770, (short)28045)) {
                  int[] var17 = 2 == var16.field9382 ? field3785.method4623(this.field3770, 0.7F, this.field3776, this.field3776, false, (byte)2) : field3785.method4622(this.field3770, 0.7F, this.field3776, this.field3776, false, 833981844);
                  this.field3769 = var17[0];
                  this.field3782 = var17[var17.length - 1];
                  this.field3780 = var1.method4854(var17, 0, this.field3776, this.field3776, this.field3776, 2072553439);
               }

               int var25 = var15 == 255 ? (var16.field9382 == 2 ? 1 : 0) : 1;
               if (1 == var25 && var11) {
               ...
               if (this.field3780 != null) {
                  ...
                  if (this.field3774 != class671.field7469) {
                     ...
                     if ((this.field3769 & -16777216) != 0) {
                        var1.method4833(0, 0, var5, 1 + var4 + var18, this.field3769, (byte)7);
                     }

                     if ((this.field3782 & -16777216) != 0) {
                        var1.method4833(0, var18 + var4 + var6, var5, var6 - (var6 + var18 + var4), this.field3782, (byte)7);
                     }
                  }
               }
            } else {
         ...
         for(int var24 = this.field3775 - 1; var24 >= 0; --var24) {
            this.field3783[var24].method4697(var1, var3, var4, var5, var6, var7, var8, this.field3787, this.field3778, this.field3792, var15);
         }
   ...
   static final void method2367(class744 var0, byte var1) {
      try {
         var0.field3161[++var0.field3156 - 1] = (int)class730.field2931 >> 3;
      } catch (RuntimeException var3) {
   ...
   public static void method2370(int var0, class312 var1) {
      int var2 = class345.method157(class923.local.field4085[0], class923.local.field4055[0], class923.local.method2550(), var1, class730.field2697.method5281(class923.local.field3639), true, class730.field2731, class730.field2719);
      class701 var3 = null;
      if (var0 == 0) {
      ...
      var3.field3364.method6419(var4.field1521);
      var3.field3364.method6415(class980.method1913(-545107710) ? 1 : 0, (byte)1);
      var3.field3364.method6419(var4.field1522);
      ...
      if (var2 > 0) {
         class95.field593 = class56.field2312[var2 - 1];
         class95.field601 = class56.field2315[var2 - 1];
      }
   ...
   static class701 method2371(int var0, int var1, int var2) {
      try {
         ...
         class389 var4 = class730.field2697.method5270(681479919);
         var3.field3364.method6419(var4.field1521 + var0);
         var3.field3364.method6415(class980.method1913(-545107710) ? 1 : 0, (byte)1);
         var3.field3364.method6419(var1 + var4.field1522);
         class95.field601 = var1;
         class95.field593 = var0;
         class95.field602 = false;
   ...
   static final void method2372(class744 var0, byte var1) {
      try {
         var0.field3157[++var0.field3158 - 1] = class537.method2316((long)var0.field3161[--var0.field3156] * 60000L, class321.field1066.method89(694163818), true, -1759893587) + " UTC";
      } catch (RuntimeException var3) {
