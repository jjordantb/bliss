public class class647 implements class331 {
   public static class647 field9228 = new class647((byte)1);
   public static class647 field9229 = new class647((byte)2);
   public byte field9230;
   public static class647 field9231 = new class647((byte)-1);
   public static int field9232 = 4;
   public static class647 field9233 = new class647((byte)0);
   static class91 field9234;

   public int method5481(byte var1) {
      try {
         return 1 + this.field9230;
      } catch (RuntimeException var3) {
         throw class158.method3445(var3, "ls.b(" + ')');
      }
   }
   ...
   public int method89(int var1) {
      try {
         ...
         throw class158.method3445(var3, "ls.f(" + ')');
      }
   }
      ...
      try {
         if (var0 != null) {
            ...
            if (var5.method4500(var0, -1961303764)) {
               class456.method3794(var5, 70180712);
            }
         }

      } catch (RuntimeException var6) {
         throw class158.method3445(var6, "ls.t(" + ')');
      }
   }
   ...
   static final void method5487(int var0, int var1, int var2, int var3, int var4) {
      try {
         ...
         throw class158.method3445(var6, "ls.x(" + ')');
      }
   }

   public static class162 method5488(int var0) {
      try {
         return class739.field2999 == null ? class162.field6597 : class739.field2999;
      } catch (RuntimeException var2) {
         throw class158.method3445(var2, "ls.u(" + ')');
      }
   }
