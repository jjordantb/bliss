    ...
    static boolean method1007(class848 var0, int var1, int var2) {
        try {
            ...
            if (!var0.method4865(2085922748)) {
                ...
                SceneGraph var6 = class730.field2697.method5317(-1611682495);
                int var7 = var3 / 2;
                byte var8 = 0;
                byte var9 = 0;
                boolean var10 = true;
                ...
                if (!var10) {
                    ...
                    if (!class95.field604) {
                        ...
                        if (var43 != null) {
                            ...
                            RegionBase var45 = class730.field2697.getRegionBase(681479919);

                            for (var23 = 0; var23 < var43.field1685; ++var23) {
                                var24 = var43.field1684[var23];
                                if (class923.local.field3639 == var24 >> 28) {
                                    var25 = (var24 >> 14 & 16383) - var45.baseX;
                                    var26 = (var24 & 16383) - var45.baseY;
