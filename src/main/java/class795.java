...
public class class795 extends class9 {
   ...
   void method454() {
      this.field527 = new class41(this.field4965, 2);
      this.field527.method3056(0);
      this.field4965.method3638(1);
      this.field4965.method3656(-16777216);
      this.field4965.method3641(260, 7681);
      this.field4965.method3669(0, 34166, 770);
   ...
   void method3001(boolean var1) {
      if (this.field527 != null) {
         ...
         this.field4965.method3638(1);
         OpenGL.glMatrixMode(5890);
         OpenGL.glLoadMatrixf(this.field4965.field6776.field325, 0);
         OpenGL.glMatrixMode(5888);
         this.field4965.method3638(0);
         if (this.field521 != this.field4965.field6749) {
            int var2 = this.field4965.field6749 % 5000 * 128 / 5000;
            ...
            if (this.field528.field8716) {
               this.field520 = (float)(this.field4965.field6749 % 4000) / 4000.0F;
            } else {
               OpenGL.glProgramLocalParameter4fARB(34336, 65, 0.0F, 0.0F, 0.0F, 1.0F);
            }

            this.field521 = this.field4965.field6749;
         }
      }
   ...
   void method2999(int var1, int var2) {
      if (this.field527 != null) {
         ...
         if ((var1 & 128) == 0) {
            if ((var2 & 1) == 1) {
               if (!this.field528.field8716) {
                  var3 = this.field4965.field6749 % 4000 * 16 / 4000;
                  this.field4965.method3639(this.field528.field8723[var3]);
                  OpenGL.glProgramLocalParameter4fARB(34336, 65, 0.0F, 0.0F, 0.0F, 1.0F);
               } else {
                  this.field4965.method3639(this.field528.field8718);
               ...
               if (this.field528.field8716) {
                  ...
                  this.field4965.method3639(this.field528.field8723[0]);
               }
         ...
         this.field4965.method3638(0);
         if ((var1 & 64) == 0) {
            field529[0] = this.field4965.field6817 * this.field4965.field6812;
            field529[1] = this.field4965.field6817 * this.field4965.field6815;
            field529[2] = this.field4965.field6817 * this.field4965.field6878;
   ...
   class795(class13 var1, class604 var2) {
      super(var1);
      this.field528 = var2;
      if (this.field4965.field6726 && this.field4965.field6852 >= 2) {
         this.field524 = class463.method4038(this.field4965, 34336, "!!ARBvp1.0\nOPTION  ARB_position_invariant;\nATTRIB  iPos         = vertex.position;\nATTRIB  iColour      = vertex.color;\nATTRIB  iTexCoord    = vertex.texcoord[0];\nOUTPUT  oColour      = result.color;\nOUTPUT  oTexCoord0   = result.texcoord[0];\nOUTPUT  oTexCoord1   = result.texcoord[1];\nOUTPUT  oFogCoord    = result.fogcoord;\nPARAM   time         = program.local[65];\nPARAM   turbulence   = program.local[64];\nPARAM   lightAmbient = program.local[66]; \nPARAM   pMatrix[4]   = { state.matrix.projection };\nPARAM   mvMatrix[4]  = { state.matrix.modelview };\nPARAM   ivMatrix[4]  = { state.matrix.texture[1] };\nPARAM   texMatrix[4]  = { state.matrix.texture[0] };\nPARAM   fNoise[64]   = { program.local[0..63] };\nTEMP    noise, viewPos, worldPos, texCoord;\nADDRESS noiseAddr;\nDP4   viewPos.x, mvMatrix[0], iPos;\nDP4   viewPos.y, mvMatrix[1], iPos;\nDP4   viewPos.z, mvMatrix[2], iPos;\nDP4   viewPos.w, mvMatrix[3], iPos;\nMOV   oFogCoord.x, viewPos.z;\nDP4   worldPos.x, ivMatrix[0], viewPos;\nDP4   worldPos.y, ivMatrix[1], viewPos;\nDP4   worldPos.z, ivMatrix[2], viewPos;\nDP4   worldPos.w, ivMatrix[3], viewPos;\nADD   noise.x, worldPos.x, worldPos.z;SUB   noise.y, worldPos.z, worldPos.x;MUL   noise, noise, 0.0001220703125;\nFRC   noise, noise;\nMUL   noise, noise, 64;\nARL   noiseAddr.x, noise.x;\nMOV   noise.x, fNoise[noiseAddr.x].x;\nARL   noiseAddr.x, noise.y;\nMOV   noise.y, fNoise[noiseAddr.x].y;\nMUL   noise, noise, turbulence.x;\nDP4   texCoord.x, texMatrix[0], iTexCoord;\nDP4   texCoord.y, texMatrix[1], iTexCoord;\nADD   oTexCoord0.xy, texCoord, noise;\nMOV   oTexCoord0.z, 0;\nMOV   oTexCoord0.w, 1;\nMUL   oTexCoord1.xy, texCoord, 0.125;\nMOV   oTexCoord1.zw, time.xxxw;\nMUL   oColour.xyz, iColour, lightAmbient;\nMOV   oColour.w, iColour.w;\nEND");
