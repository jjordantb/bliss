                ...
                try {
                    if (var0 == 1) {
                        ...
                        if (16 == var0) {
                            ...
                            RegionOffset var9;
                            if (29 == var0) {
                                var9 = class923.local.getRegion().regionOffset;
                                class213.method3810(((int) var9.offsetX >> 9) + " " + ((int) var9.offsetY >> 9), 2030018099);
                            } else if (var0 == 7) {
                                var9 = class923.local.getRegion().regionOffset;
                                class213.method3810("" + class730.field2697.method5317(-1611682495).field3862[class923.local.field3639].method3888((int) var9.offsetX >> 9, (int) var9.offsetY >> 9, (byte) -102), 417961088);
                            } else if (var0 == 3) {
