public class class924 extends class23 {
   ...
   static void method6251(class744 var0, byte var1) {
      try {
         var0.field3161[var0.field3156 * 681479919 - 1] = class735.field3009.method4224(var0.field3161[681479919 * var0.field3156 - 1], 245040087).field8989 * 126451825;
   ...
   public static void method6252(class48[] var0, int var1) {
      try {
         class544.field3794 = -1283115375 * var0.length;
         class602.field8668 = new class48[class544.field3794 * -232961423 + 10];
         class755.field4199 = new int[-232961423 * class544.field3794 + 10];
         System.arraycopy(var0, 0, class602.field8668, 0, -232961423 * class544.field3794);

         int var2;
         for(var2 = 0; var2 < -232961423 * class544.field3794; ++var2) {
            class755.field4199[var2] = class602.field8668[var2].method3109();
         }

         for(var2 = class544.field3794 * -232961423; var2 < class602.field8668.length; ++var2) {
   ...
   static class907 method6254(int var0) {
      try {
         class907 var1 = class398.method3541(-68618923);
         var1.method6385(0L);
   ...
   static void method6255(class744 var0, int var1) {
      try {
         var0.field3157[(var0.field3158 += 969361751) * -203050393 - 1] = class735.field3009.method4224(var0.field3161[(var0.field3156 -= -391880689) * 681479919], 245040087).field8985;
      } catch (RuntimeException var3) {
