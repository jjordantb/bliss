public class class695 {
   ...
   void method3936(byte[] var1, int var2) {
      try {
         class907 var3 = new class907(class35.method3335(var1, -1012105553));
         int var4 = var3.method6371();
         if (var4 >= 5 && var4 <= 7) {
            if (var4 >= 6) {
               this.field7267 = var3.method6420((byte)-6) * 967231547;
            } else {
               this.field7267 = 0;
            }
            ...
            if (var4 >= 7) {
               this.field7265 = var3.method6384(-2145456050) * -1409433829;
            } else {
               this.field7265 = var3.method6374() * -1409433829;
            }

            int var8 = 0;
            int var9 = -1;
            this.field7256 = new int[-2145352941 * this.field7265];
            int var10;
            if (var4 >= 7) {
               for(var10 = 0; var10 < this.field7265 * -2145352941; ++var10) {
               ...
               for(var10 = 0; var10 < -2145352941 * this.field7265; ++var10) {
            ...
            this.field7259 = (var9 + 1) * 1621334929;
            this.field7260 = new int[-1583970959 * this.field7259];
            if (var7) {
               this.field7254 = new byte[this.field7259 * -1583970959][];
            }

            this.field7252 = new int[-1583970959 * this.field7259];
            this.field7263 = new int[-1583970959 * this.field7259];
            this.field7264 = new int[this.field7259 * -1583970959][];
            this.field7255 = new int[this.field7259 * -1583970959];
            if (var6) {
               this.field7257 = new int[-1583970959 * this.field7259];

               for(var10 = 0; var10 < -1583970959 * this.field7259; ++var10) {
   ...
   class695(byte[] var1, int var2, byte[] var3) {
      this.field7251 = class528.method2247(var1, var1.length, -1939068825) * -720041561;
      if (var2 != 1600327191 * this.field7251) {
         throw new RuntimeException();
      } else {
         if (var3 != null) {
            if (var3.length != 64) {
   ...
   public static class471 method3937(int var0, byte var1) {
      try {
         return class886.field10136 && var0 >= class769.field3692 * -1648308965 && var0 <= class886.field10135 * -499146007 ? class277.field10606[var0 - class769.field3692 * -1648308965] : null;
   ...
   static final void method3939(class744 var0, byte var1) {
      try {
         class842.method5468((String)var0.field3157[(var0.field3158 -= 969361751) * -203050393], -1257906929);
      } catch (RuntimeException var3) {
