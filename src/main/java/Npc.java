public class Npc extends Actor {
   ...
   class192 method2201(class848 var1, int var2) {
      try {
         if (this.field1637 != null && this.method1238(var1, 526336, -1241441124)) {
            ...
            class190 var7 = super.field3638.field3861[super.field3639][(int)var4.field7637.field5296 >> 9][(int)var4.field7637.field5299 >> 9];
   ...
   public void method1240(int var1, int var2, int var3, boolean var4, int var5, byte var6) {
      try {
         ...
         var11.field5296 = (float)((var5 << 8) + (super.field4085[0] << 9));
         var11.field5299 = (float)((super.field4055[0] << 9) + (var5 << 8));
   ...
   public Npc(class545 var1, int var2) {
      super(var1, var2);
