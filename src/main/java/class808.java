public class class808 {
    ...
    static final void method2892(class513 var0, int var1) {
        try {
            ...
            int var7 = var4 & 16383;
            RegionBase var8 = class730.field2697.getRegionBase(681479919);
            var3.field4085[0] = var6 - var8.baseX;
            var3.field4055[0] = var7 - var8.baseY;
            var3.method1515((float) ((var3.field4085[0] << 9) + (var3.method2550() << 8)), var3.method1517().regionOffset.field5300, (float) ((var3.field4055[0] << 9) + (var3.method2550() << 8)));
