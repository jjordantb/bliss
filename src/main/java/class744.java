...
public class class744 {
   ...
   static final void method1901(class744 var0, byte var1) {
      try {
         ...
         var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = class906.field10363.method2713(var2, (short)-1307).field10617[var3];
   ...
   static final void method1903(long var0) {
      try {
         ...
         if (class456.field7163 * 1103750049 != var2) {
            var4 = var2 - 1103750049 * class456.field7163;
            ...
            class456.field7163 += -1832337311 * var5;
         }

         if (class530.field3741 * 1346160791 != var3) {
            var4 = var3 - 1346160791 * class530.field3741;
   ...
   static final void method1904(class744 var0, int var1) {
      try {
         if (-932179775 * var0.field3167 != 0) {
            class596 var2 = var0.field3166[(var0.field3167 -= 373063489) * -932179775];
            var0.field3177 = var2.field2143;
            var0.field3175 = var0.field3177.field173;
            var0.field3174 = var0.field3177.field174;
            var0.field3176 = var2.field2140 * -2092362779;
