public class class853 extends class106 {
   ...
   int field8830;
   int field8831;
   int field8832 = -703557345;
   class120 field8833;

   void method169(class907 var1) {
      this.field8832 = var1.method6374() * 703557345;
      this.field8830 = var1.method6420((byte)-17) * -2070878551;
      this.field8829 = var1.method6371() * 1472973945;
      this.field8831 = var1.method6371() * -2026849051;
   }

   void method168(class907 var1, int var2) {
      try {
         this.field8832 = var1.method6374() * 703557345;
         this.field8830 = var1.method6420((byte)-51) * -2070878551;
         this.field8829 = var1.method6371() * 1472973945;
         this.field8831 = var1.method6371() * -2026849051;
   ...
   void method170(class420 var1, byte var2) {
      try {
         var1.method5792(this.field8832 * 1553093921, 1564286361 * this.field8830, -549921335 * this.field8829, -815095571 * this.field8831, 1468096534);
      } catch (RuntimeException var4) {
   ...
   void method171(class420 var1) {
      var1.method5792(this.field8832 * 1553093921, 1564286361 * this.field8830, -549921335 * this.field8829, -815095571 * this.field8831, 1036720965);
   }

   void method172(class907 var1) {
      this.field8832 = var1.method6374() * 703557345;
      this.field8830 = var1.method6420((byte)82) * -2070878551;
      this.field8829 = var1.method6371() * 1472973945;
      this.field8831 = var1.method6371() * -2026849051;
   }
