public abstract class class454 {
   ...
   public final int method3887(int var1, int var2, int var3) {
      try {
         ...
         if (var4 >= 0 && var5 >= 0 && var4 <= this.field7226 - 1 && var5 <= this.field7225 - 1) {
            int var6 = var1 & this.field7227 - 1;
            int var7 = var2 & this.field7227 - 1;
            int var8 = (this.field7227 - var6) * this.field7229[var4][var5] + var6 * this.field7229[var4 + 1][var5] >> this.field7228;
            int var9 = var6 * this.field7229[1 + var4][1 + var5] + (this.field7227 - var6) * this.field7229[var4][var5 + 1] >> this.field7228;
