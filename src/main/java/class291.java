...
public class class291 extends SceneGraphLevel {
    ...
    class291(class13 var1, int var2, int var3, int var4, int var5, int[][] var6, int[][] var7, int var8) {
        ...
        this.field10487 = super.field7228 - 2;
        ...
        this.field10497 = new float[super.width + 1][super.height + 1];
        this.field10514 = new float[super.width + 1][super.height + 1];
        this.field10515 = new float[super.width + 1][super.height + 1];

        for (int var9 = 1; var9 < super.height; ++var9) {
            for (int var10 = 1; var10 < super.width; ++var10) {
    ...
    public void method3898() {
        if (this.field10510 > 0) {
            byte[][] var1 = new byte[super.width + 1][super.height + 1];

            int var2;
            for (var2 = 1; var2 < super.width; ++var2) {
                for (int var3 = 1; var3 < super.height; ++var3) {
            ...
            int var9;
            int var10;
            for (var9 = 0; var9 < super.width; ++var9) {
                for (var10 = 0; var10 < super.height; ++var10) {
                    if (this.field10495[var9][var10] != null) {
                        ...
                        short[] var80 = this.field10517[var10 * super.width + var9] = new short[var15.length];

                        for (int var81 = 0; var81 < var15.length; ++var81) {
                            var37 = (var9 << super.field7228) + var12[var81];
                            int var38 = (var10 << super.field7228) + var13[var81];
                            ...
                            if (var46 == 0 && var47 == 0) {
                                ...
                                var53 = var20;
                                var82 = var48 - var30;
                            } else if (var46 == 0 && var47 == super.field7227) {
                                var51 = var21;
                                var52 = var22;
                                var53 = var23;
                                var82 = var48 - var31;
                            } else if (var46 == super.field7227 && var47 == super.field7227) {
                                var51 = var24;
                                var52 = var25;
                                var53 = var26;
                                var82 = var48 - var32;
                            } else if (var46 == super.field7227 && var47 == 0) {
                                var51 = var27;
                                var52 = var28;
                                var53 = var29;
                                var82 = var48 - var33;
                            } else {
                                float var54 = (float) var46 / (float) super.field7227;
                                float var55 = (float) var47 / (float) super.field7227;
                                ...
                                int var62 = var30 + ((var33 - var30) * var46 >> super.field7228);
                                int var63 = var31 + ((var32 - var31) * var46 >> super.field7228);
                                var82 = var48 - (var62 + ((var63 - var62) * var47 >> super.field7228));
                            }
                            ...
                            if (var85 == null) {
                                ...
                                var84 = var80[var81] & '\uffff';
                                if (var41 != -1 && var11[var81].field641 < var5[var84].field641) {
                                    var5[var84] = var11[var81];
                                }
                            }
            ...
            for (var9 = 0; var9 < super.width; ++var9) {
                for (var10 = 0; var10 < super.height; ++var10) {
                    short[] var67 = this.field10517[var10 * super.width + var9];
                    if (var67 != null) {
                        int var70 = 0;
                        ...
                        for (int var72 = 0; var72 < var67.length; ++var70) {
                            ...
                            if (var77 != null) {
                                ...
                                if (var79 == null || var77.field641 < var79.field641) {
                                    var79 = var77;
                                }
                            }
                            ...
                            if (var78 != null) {
                                ...
                                if (var79 == null || var78.field641 < var79.field641) {
                                    var79 = var78;
                                }
                            }
    ...
    void method6525(int var1, int var2, int var3, boolean[][] var4, boolean var5, int var6) {
        if (this.field10501 != null) {
            ...
            int var12 = var1 + var3;
            if (var12 > super.width - 1) {
                var12 = super.width - 1;
            }

            int var13 = var2 + var3;
            if (var13 > super.height - 1) {
                var13 = super.height - 1;
            }
            ...
            for (var16 = var8; var16 <= var12; ++var16) {
                ...
                for (int var18 = var10; var18 <= var13; ++var18) {
                    if (var17[var18 - var11]) {
                        var15[var14++] = var18 * super.width + var16;
                    }
                }
            }
    ...
    public void method3886(int var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean[][] var8) {
        ...
        if (this.field10510 > 0 && var9 != null) {
            ...
            this.field10502.method3658(-2);
            this.field10502.method3639((class203) null);
            field10491[0] = (float) var3 / (128.0F * (float) super.field7227 * (float) var9.method2481());
            field10491[1] = 0.0F;
            field10491[2] = 0.0F;
            field10491[3] = 0.0F;
            field10491[4] = 0.0F;
            field10491[5] = (float) var3 / (128.0F * (float) super.field7227 * (float) var9.method2493());
            field10491[6] = 0.0F;
            field10491[7] = 0.0F;
            field10491[8] = 0.0F;
            field10491[9] = 0.0F;
            ...
            if (var10 > 0) {
                class424 var17 = new class424(this.field10502, 5123, var11.field10375, var11.field10376);
    ...
    public class770 method3889(int var1, int var2, class770 var3) {
        if ((this.field10513[var1][var2] & 1) == 0) {
            ...
            int var4 = super.field7227 >> this.field10502.field6751;
    ...
    public void method3882(int var1, int var2, int[] var3, int[] var4, int[] var5, int[] var6, int[] var7, int[] var8, int[] var9, int[] var10, class919 var11, boolean var12) {
        ...
        if (var6 != null && this.field10500 == null) {
            this.field10500 = new int[super.width][super.height][];
        }

        if (var4 != null && this.field10499 == null) {
            this.field10499 = new int[super.width][super.height][];
        }
