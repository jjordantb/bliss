...
public class class291 extends class454 {
   ...
   public void method3898() {
      if (this.field10510 > 0) {
         ...
         int var2;
         for(var2 = 1; var2 < super.field7226; ++var2) {
            for(int var3 = 1; var3 < super.field7225; ++var3) {
         ...
         int var9;
         int var10;
         for(var9 = 0; var9 < super.field7226; ++var9) {
            for(var10 = 0; var10 < super.field7225; ++var10) {
               if (this.field10495[var9][var10] != null) {
                  ...
                  short[] var80 = this.field10517[var10 * super.field7226 + var9] = new short[var15.length];
         ...
         for(var9 = 0; var9 < super.field7226; ++var9) {
            for(var10 = 0; var10 < super.field7225; ++var10) {
               short[] var67 = this.field10517[var10 * super.field7226 + var9];
               if (var67 != null) {
                  int var70 = 0;
         ...
         for(var16 = var8; var16 <= var12; ++var16) {
            ...
            for(int var18 = var10; var18 <= var13; ++var18) {
               if (var17[var18 - var11]) {
                  var15[var14++] = var18 * super.field7226 + var16;
               }
            }
         }
      ...
      if (this.field10510 > 0 && var9 != null) {
         ...
         if (this.field10502.field6830) {
            for(var12 = var5; var12 < var7; ++var12) {
               var13 = var12 * super.field7226 + var4;
   ...
   public void method3882(int var1, int var2, int[] var3, int[] var4, int[] var5, int[] var6, int[] var7, int[] var8, int[] var9, int[] var10, class919 var11, boolean var12) {
      ...
      if (var6 != null && this.field10500 == null) {
         this.field10500 = new int[super.field7226][super.field7225][];
      }

      if (var4 != null && this.field10499 == null) {
         this.field10499 = new int[super.field7226][super.field7225][];
      }
   ...
   class291(class13 var1, int var2, int var3, int var4, int var5, int[][] var6, int[][] var7, int var8) {
      ...
      this.field10497 = new float[super.field7226 + 1][super.field7225 + 1];
      this.field10514 = new float[super.field7226 + 1][super.field7225 + 1];
      this.field10515 = new float[super.field7226 + 1][super.field7225 + 1];

      for(int var9 = 1; var9 < super.field7225; ++var9) {
         for(int var10 = 1; var10 < super.field7226; ++var10) {
