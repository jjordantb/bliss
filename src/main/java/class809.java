public class class809 implements class925 {
   ...
   class809(int var1, class971 var2, class49 var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, boolean var11) {
      this.field4593 = 846852233 * var1;
      this.field4588 = var2;
      this.field4589 = var3;
      this.field4585 = 1894702875 * var4;
      this.field4587 = 943071961 * var5;
      this.field4591 = var6 * -415795561;
      this.field4592 = 245978315 * var7;
      this.field4584 = var8 * 337066221;
      this.field4586 = 236352403 * var9;
      this.field4590 = var10 * 680370675;
