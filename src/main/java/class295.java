public class class295 {
   ...
   static final void method6517(class744 var0, int var1) {
      try {
         var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = class615.field8903.field9127.method4420((byte)0) ? 1 : 0;
   ...
   static final void method6518(class744 var0, int var1) {
      try {
         var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = class615.field8903.field9122.method2652((byte)-40) ? 1 : 0;
      } catch (RuntimeException var3) {
   ...
   static final void method6519(class744 var0, int var1) {
      try {
         var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = class44.method3084((byte)89);
      } catch (RuntimeException var3) {
   ...
   public static void method6520(int var0, int var1, int var2, boolean var3, int var4) {
      try {
         if (class615.field8903.field9137.method3689(-1456138007) != 0) {
            class740.field3200 = class615.field8903.field9137.method3689(-993679742) * 485258093;
            class337.method77(0, true, 622850291);
         } else {
            class371.method867(false, 1336561252);
         }

         class740.field3203 = -1801430445 * var1;
         class740.field3197 = var2 * -1505298155;
   ...
   static void method6521(int var0, int var1, int var2, int var3, int var4) {
      try {
         float var5 = (float)class740.field7815 / (float)class740.field7814;
         int var6 = var2;
         int var7 = var3;
         if (var5 < 1.0F) {
         ...
         var0 -= (var2 - var6) / 2;
         var1 -= (var3 - var7) / 2;
         class896.field9358 = -2076584633 * (class740.field7814 * var0 / var6);
         class747.field4148 = -435591305 * (class740.field7815 - class740.field7815 * var1 / var7);
            ...
            if (var9 != null && var9.field10287 * 958933333 != 0 && class730.field2866 * 443738891 % 20 < 10) {
               ...
               if (1 == 958933333 * var9.field10287) {
                  ...
                  if (var10 != null) {
                     ...
                     var13 = (int)var12.field5296 / 128 - var0 / 128;
                     int var14 = (int)var12.field5299 / 128 - var1 / 128;
                     class515.method2695(var2, var3, var4, var5, var13, var14, -92466201 * var9.field10279, 360000L);
                  }
               }

               if (var9.field10287 * 958933333 == 2) {
                  int var18 = var9.field10281 * -1338192389 / 128 - var0 / 128;
                  int var20 = var9.field10282 * 1018128075 / 128 - var1 / 128;
                  long var15 = (long)(var9.field10278 * 2140036693 << 7);
                  var15 *= var15;
               ...
               if (10 == 958933333 * var9.field10287 && -841622081 * var9.field10277 >= 0 && var9.field10277 * -841622081 < class730.field2786.length) {
                  ...
                  if (var19 != null) {
                     ...
                     var13 = (int)var21.field5299 / 128 - var1 / 128;
                     class515.method2695(var2, var3, var4, var5, var22, var13, var9.field10279 * -92466201, 360000L);
                  }
               }
            }
         }
