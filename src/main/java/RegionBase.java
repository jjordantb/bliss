public class RegionBase {
    ...
    public RegionBase(int var1, int var2, int var3) {
        this.field1523 = var1;
        this.baseX = var2;
        this.baseY = var3;
    }

    public RegionBase(int var1) {
        if (-1 == var1) {
            this.field1523 = -1;
        } else {
            this.field1523 = var1 >> 28 & 3;
            this.baseX = var1 >> 14 & 16383;
            this.baseY = var1 & 16383;
        }
    ...
    static final void method1151(Actor var0, boolean var1, int var2) {
        try {
            ...
            if (var0.field4084 == 0) {
                var0.field4088 = 0;
                SceneGraph.field3910 = class647.field9231.field9230;
                ...
                RegionOffset var20 = RegionOffset.translate(var0.getRegion().regionOffset);
                int var21 = (int) var20.offsetX;
                int var22 = (int) var20.offsetY;
                ...
                if (var1 || var7 - var21 <= 1024 && var7 - var21 >= -1024 && var8 - var22 <= 1024 && var8 - var22 >= -1024) {
                    ...
                    if (-1 != var3.field4010 * -1520103925) {
                        ...
                        if (var0.field4084 == 1) {
                            ...
                            int var13 = ((int) var20.offsetX > var7 ? (int) var20.offsetX - var7 : var7 - (int) var20.offsetX) << 9;
                            int var14 = ((int) var20.offsetY > var8 ? (int) var20.offsetY - var8 : var8 - (int) var20.offsetY) << 9;
                    ...
                    if (var7 == var21 && var8 == var22) {
                        ...
                        if (var21 < var7) {
                            var20.offsetX += (float) var10;
                            class488.field8423 |= 4;
                            if (var20.offsetX > (float) var7) {
                                var20.offsetX = (float) var7;
                            }
                        } else if (var21 > var7) {
                            var20.offsetX -= (float) var10;
                        ...
                        if (var22 < var8) {
                            var20.offsetY += (float) var10;
                            class488.field8423 |= 1;
                            if (var20.offsetY > (float) var8) {
                                var20.offsetY = (float) var8;
                            }
                        } else if (var22 > var8) {
                            var20.offsetY -= (float) var10;
                        ...
                        if (var10 >= 32) {
                            SceneGraph.field3910 = class647.field9229.field9230;
                        } else {
                            SceneGraph.field3910 = var9;
                        }
                    }

                    if ((int) var20.offsetX == var7 && (int) var20.offsetY == var8) {
                        --var0.field4084;
                        if (var0.field4089 > 0) {
                            --var0.field4089;
                        }
    ...
    public static void method1154(int var0, int var1, int var2, int var3, short var4) {
        try {
            ...
            for (var5 = (class206) class206.field7098.method901(1766612795); var5 != null; var5 = (class206) class206.field7098.method906(49146)) {
                ...
                var13 = var5.field7076.getRegion().regionOffset;
                var5.field7068 = (int) var13.offsetX;
                var5.field7070 = (int) var13.offsetX + (var5.field7076.method2550() << 8);
                var5.field7066 = (int) var13.offsetY;
                var5.field7071 = (int) var13.offsetY + (var5.field7076.method2550() << 8);
            ...
            for (var5 = (class206) class206.field7083.method2946(2005558160); var5 != null; var5 = (class206) class206.field7083.method2945((byte) -39)) {
                ...
                var13 = var5.field7077.getRegion().regionOffset;
                var5.field7068 = (int) var13.offsetX;
                var5.field7070 = (int) var13.offsetX + (var5.field7077.method2550() << 8);
                var5.field7066 = (int) var13.offsetY;
                var5.field7071 = (int) var13.offsetY + (var5.field7077.method2550() << 8);
    ...
    public String toString() {
        try {
            return this.field1523 + "," + (this.baseX >> 6) + "," + (this.baseY >> 6) + "," + (this.baseX & 63) + "," + (this.baseY & 63);
