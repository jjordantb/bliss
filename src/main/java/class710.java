public class class710 extends class827 {
   ...
   class710(class971 var1, class49 var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15) {
      ...
      this.field3453 = 89435289 * var10;
      this.field3452 = -1260843603 * var11;
      this.field3456 = -799581693 * var12;
      this.field3454 = var13 * -2019305103;
      this.field3455 = 1077315483 * var14;
      this.field3451 = var15 * 1415948423;
   }
   ...
   static final void method2027(class744 var0, int var1) {
      try {
         ...
         if (var3 == null) {
            ...
            var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = var3.intValue();
         }
