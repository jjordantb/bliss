   ...
   class169 method6479() {
      if (this.field1142 == null) {
         ...
         for(var4 = 0; var4 < 6; ++var4) {
            if (!var1.method4621(field1149[var4], (short)19541)) {
               return null;
            }

            class414 var5 = var1.method4625(field1149[var4], 179143971);
         ...
         for(var4 = 0; var4 < 6; ++var4) {
            field1150[var4] = var1.method4622(field1149[var4], 1.0F, var3, var3, false, -244439227);
         }
