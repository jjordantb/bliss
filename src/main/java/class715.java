public class class715 extends class732 implements class265 {
    ...
    public int method4548(int var1) {
        try {
            return this.field3585.field375;
        } catch (RuntimeException var3) {
    ...
    public int method4549(short var1) {
        try {
            return this.field3585.field376;
        } catch (RuntimeException var3) {
    ...
    class192 method2201(class848 var1, int var2) {
        try {
            ...
            if (var3 == null) {
                ...
                var4.method1018((float) super.field2978, 0.0F, (float) super.field2979);
                class446 var5 = this.getRegion();
                ...
                if (this.field3584 == null) {
                    this.field3584 = class905.method6344((int) var5.regionOffset.offsetX, (int) var5.regionOffset.field5300, (int) var5.regionOffset.offsetY, var3, 2072413227);
                } else {
                    class364.method1613(this.field3584, (int) var5.regionOffset.offsetX, (int) var5.regionOffset.field5300, (int) var5.regionOffset.offsetY, var3, (byte) 84);
                }
