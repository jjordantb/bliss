public class class903 extends class535 {
   public static int field10358 = 1;
   public static int field10359 = 0;

   int method2272(int var1) {
      return 1;
   }

   public class903(int var1, class838 var2) {
      super(var1, var2);
   }
