...
public class class58 {
    ...
    public class518 method1566(int var1) {
    ...
    public class518 method1569(int var1, boolean var2) {
        try {
            class518 var4;
            if (!var2) {
                class1 var3 = this.field2334;
                synchronized(this.field2334) {
                    var4 = (class518)this.field2334.method2974((long)var1);
                }
            ...
            if (!var2 && method1568(var1)) {
                var5 = this.field2331.method3285(class981.field3240.method1927(var1 + class85.field1121.field2328 * -888767613, -100335020), class981.field3240.method1925(var1 + class85.field1121.field2328 * -888767613, -1698958016), (byte)-74);
                var13 = true;
            }
            ...
            var4 = new class518();
            var4.field4269 = this;
            var4.field4258 = 1824752127 * var1;
            var4.field4240 = (String[])this.field2329.clone();
            var4.field4249 = (String[])this.field2341.clone();
            var4.method2691();
            if (var5 != null) {
                var4.method2671(new class907(var5), var13);
            }

            var4.method2670(16711935);
            if (-1 != var4.field4273 * -1673957995) {
                var4.method2673(this.method1569(var4.field4273 * -1673957995, var2), this.method1569(809765849 * var4.field4226, var2), 219692629);
            }

            if (var4.field4236 * 465190555 != -1) {
                var4.method2685(this.method1569(var4.field4236 * 465190555, var2), this.method1569(-783380935 * var4.field4274, var2), -1676050822);
            }

            if (-1 != 2083650097 * var4.field4288) {
                var4.method2682(this.method1569(var4.field4288 * 2083650097, var2), this.method1569(1981372535 * var4.field4287, var2), -1733915014);
            }
            ...
            if (!this.field2340 && var4.field4248) {
                ...
                if (var4.field4284 != null) {
                    ...
                    for(class568 var7 = var4.field4284.method2946(1739772889); var7 != null; var7 = var4.field4284.method2945((byte)-94)) {
                        class785 var8 = this.field2330.method5148((int)(var7.field641 * 7051297995265073167L), -1474104007);
                        if (var8.field3824) {
    ...
    public class48 method1570(class848 var1, int var2, int var3, int var4, int var5, int var6, class365 var7, int var8) {
        try {
            this.field2337.field3749 = -973477563 * var1.field8580;
            this.field2337.field3744 = var2 * 1541800549;
            this.field2337.field3745 = -1199949713 * var3;
            this.field2337.field3746 = var4 * 29186943;
            this.field2337.field3748 = var5 * 1868109305;
            this.field2337.field3747 = var6 * 958157807;
    ...
    public class48 method1571(class848 var1, class848 var2, int var3, int var4, int var5, int var6, boolean var7, boolean var8, int var9, class727 var10, class365 var11, int var12) {
        try {
            ...
            class518 var18 = this.method1566(var3);
            ...
            if (var19 == null) {
                ...
                if (!var8) {
                    ...
                    var16.field3749 = -973477563 * var2.field8580;
                    var16.field3744 = var3 * 1541800549;
                    var16.field3745 = var4 * -1199949713;
                    var16.field3746 = 29186943 * var5;
                    var16.field3748 = var6 * 1868109305;
                    var16.field3747 = 958157807 * var9;
    ...
    static final void method1579(int var0, byte var1) {
        try {
            ...
            int var2 = class539.field3762.method5739(var0, -482836609).field9816 * -65795773;
            if (var2 != 0) {
