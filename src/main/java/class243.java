...
public class class243 {
    ...
    class243(class13 var1, class291 var2) {
        this.field8506 = var1;
        this.field8504 = var2;
        this.field8503 = 2 + (this.field8504.width * this.field8504.field7227 >> this.field8506.field6751);
        this.field8501 = 2 + (this.field8504.height * this.field8504.field7227 >> this.field8506.field6751);
        this.field8505 = new byte[this.field8503 * this.field8501];
        this.field8508 = 7 + this.field8506.field6751 - this.field8504.field7228;
        this.field8502 = this.field8504.width >> this.field8508;
        this.field8507 = this.field8504.height >> this.field8508;
    }
                ...
                for (var10 = 0; var10 < this.field8502; ++var10) {
                    ...
                    for (int var15 = var8; var15 < var9; ++var15) {
                        if (var15 - var2 >= -var3 && var15 - var2 <= var3) {
                            int var16 = var15 * this.field8504.width + var12;
