public class class900 {
   static class900 field10370 = new class900(2, 6);
   static class900 field10371 = new class900(1, 5);
   static class900 field10372 = new class900(0, 4);
   int field10373;
   ...
   public static void method6347(Widget var0, int var1, int var2, int var3) {
      try {
         ...
         throw class158.method3445(var5, "fy.kc(" + ')');
      }
   }
   ...
   static void method6348(byte var0) {
      try {
         ...
         throw class158.method3445(var2, "fy.f(" + ')');
      }
   }
}
