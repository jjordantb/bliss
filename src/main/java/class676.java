public abstract class class676 extends Interactable {
    ...
    class676(SceneGraph var1, int var2, int var3, int var4, int var5, int var6, int var7) {
        super(var1);
    ...
    int method2161(class639[] var1, int var2) {
        try {
            ...
            int var4 = (int) var3.offsetX >> super.field3638.field3849;
            int var5 = (int) var3.offsetY >> super.field3638.field3849;
            int var6 = 0;
    ...
    boolean method2171(class848 var1, byte var2) {
        try {
            RegionOffset var3 = this.getRegion().regionOffset;
            return super.field3638.field3857.method1652(this, super.field3640, (int) var3.offsetX >> super.field3638.field3849, (int) var3.offsetY >> super.field3638.field3849);
        } catch (RuntimeException var4) {
    ...
    boolean method2167(int var1) {
        try {
            ...
            return super.field3638.field3908[super.field3638.field3883 + (((int) var2.offsetX >> super.field3638.field3849) - super.field3638.field3898)][super.field3638.field3883 + (((int) var2.offsetY >> super.field3638.field3849) - super.field3638.field3858)];
