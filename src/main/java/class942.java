public class class942 {
    ...
    public class942(class469 var1, class423 var2, class180 var3) {
        ...
        this.field10346 = this.field10347.method3286(class981.field3235.field3271, -1214131434);
    }
    ...
    public static boolean method6333(String var0, int var1) {
        try {
            if (var0 == null) {
                ...
                return var0.equalsIgnoreCase(class923.local.field3374);
            }
        ...
        try {
            ...
            if (var4 != null) {
                ...
                synchronized (this.field10347) {
                    var10 = this.field10347.method3285(class981.field3235.field3271, var1, (byte) -73);
                }

                var4 = new class871();
                if (var10 != null) {
                    var4.method5897(new InputStream(var10), 1327711716);
                }
