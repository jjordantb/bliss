public class class929 extends class304 {
   public void method2385() {
      class503.method2587(true, (short)3546);
   }
   ...
   public void method2386() {
      class503.method2587(true, (short)8961);
   }

   class929(class907 var1) {
      super(var1);
   }
   ...
   static void method6263(class564 var0, int var1, int var2, boolean var3, byte var4) {
      try {
         int var5 = -2093041337 * var0.field881;
         int var6 = var0.field887 * 457937409;
         if (var0.field873 == 0) {
            var0.field881 = var0.field978 * -86683899;
         } else if (1 == var0.field873) {
            var0.field881 = -614915977 * (var1 - 1769572195 * var0.field978);
         } else if (2 == var0.field873) {
            var0.field881 = -614915977 * (var1 * 1769572195 * var0.field978 >> 14);
         }

         if (var0.field874 == 0) {
            var0.field887 = -472364941 * var0.field878;
         } else if (1 == var0.field874) {
            var0.field887 = (var2 - var0.field878 * -1747263885) * -67604991;
         } else if (var0.field874 == 2) {
            var0.field887 = -67604991 * (var2 * -1747263885 * var0.field878 >> 14);
         }

         if (var0.field873 == 4) {
            var0.field881 = -614915977 * (var0.field883 * 1183580231 * var0.field887 * 457937409 / (var0.field967 * 1289873889));
         }
         ...
         if (class730.field2828 && (class730.method1761(var0).field2563 * -1266165749 != 0 || var0.field869 * -1215239439 == 0)) {
            if (var0.field887 * 457937409 < 5 && -2093041337 * var0.field881 < 5) {
               ...
               if (457937409 * var0.field887 <= 0) {
                  var0.field887 = -338024955;
               }

               if (var0.field881 * -2093041337 <= 0) {
                  var0.field881 = 1220387411;
               }
            }
         }
   ...
   static void method6264(class744 var0, byte var1) {
      try {
         var0.field3161[681479919 * var0.field3156 - 2] = class735.field3009.method4224(var0.field3161[var0.field3156 * 681479919 - 2], 245040087).field8994[var0.field3161[var0.field3156 * 681479919 - 1]][0];
