public class class279 {
   ...
   void method6609(class907 var1, int var2) {
      try {
         while(true) {
   ...
   public boolean method6610(byte var1) {
      try {
         return this.field10585.field3426.method3280(this.field10587 * 1690480405, -457216440);
   ...
   public class48 method6611(class848 var1, int var2, boolean var3, byte var4) {
      try {
         long var5 = (long)(this.field10587 * 1690480405 | var2 << 16 | (var3 ? 262144 : 0) | var1.field8580 * 580915349 << 19);
         class48 var7 = (class48)this.field10585.field3423.method2974(var5);
         if (var7 != null) {
            return var7;
         } else if (!this.field10585.field3426.method3280(this.field10587 * 1690480405, -457216440)) {
            return null;
         } else {
            class922 var8 = class922.method6242(this.field10585.field3426, 1690480405 * this.field10587, 0);
            if (var8 != null) {
               var8.field10268 = 0;
               var8.field10271 = 0;
               var8.field10272 = 0;
   ...
   void method6612(class907 var1, int var2, int var3) {
      try {
         if (var2 == 1) {
            this.field10587 = var1.method6423(1235052657) * 24979517;
         } else if (2 == var2) {
            this.field10586 = var1.method6390((byte)1) * 1870808461;
         } else if (3 == var2) {
            this.field10588 = true;
         } else if (var2 == 4) {
            this.field10587 = -24979517;
         }
