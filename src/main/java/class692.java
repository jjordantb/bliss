public class class692 {
   ...
   public class692(class401 var1, boolean var2) {
      if (var2) {
   ...
   public class692(long var1, int[] var3, short[] var4, short[] var5) {
      this.field7133 = 3177550440302969639L * var1;
      this.field7131 = var3;
      this.field7132 = var4;
      this.field7130 = var5;
   }

   public static class24 method3776(class907 var0, byte var1) {
      try {
         class24 var2 = new class24();
         var2.field6482 = var0.method6374() * -1496580327;
         var2.field6483 = class906.field10363.method2713(var2.field6482 * -2034569943, (short)-12386);
         return var2;
   ...
   static final void method3777(class744 var0, byte var1) {
      try {
         var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = class615.field8903.field9153.method2717(-2147059683);
      } catch (RuntimeException var3) {
