public class class47 {
   ...
   class47(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, boolean var10, int var11) {
      this.field5172 = 1348854581 * var1;
   ...
   static final void method3086(class848 var0, int var1, int var2, int var3, int var4, int var5) {
      try {
         ...
         if (class740.field3198 * -1289394455 >= 100) {
            float var6 = (float)class740.field7815 / (float)class740.field7814;
            int var7 = var3;
            int var8 = var4;
            if (var6 < 1.0F) {
            ...
            if (class77.field1516 == null || class77.field1516.method3106() != var3 || class77.field1516.method3108() != var4) {
               class740.method4416(class740.field7820, class740.field7813 + class740.field7815, class740.field7820 + class740.field7814, class740.field7813, var1, var2, var7 + var1, var8 + var2);
            ...
            int var9 = var7 * 1484045541 * class740.field3199 / class740.field7814;
            int var10 = 1464638883 * class162.field6603 * var8 / class740.field7815;
            ...
            if (class10.field6652 * -1983068885 > 0) {
               int var14;
               if (-1581933633 * class622.field9010 > 50) {
                  var14 = 500 - class622.field9010 * 680266427;
               } else {
                  var14 = 680266427 * class622.field9010;
               }

               for(class392 var15 = (class392)class740.field7811.method901(1766612795); var15 != null; var15 = (class392)class740.field7811.method906(49146)) {
                  class718 var16 = class740.field7826.method5091(-530122905 * var15.field5396, -1892291274);
                  if (class517.method2719(var16, 1502593597)) {
                     int var17;
                     int var18;
                     if (class740.field3207 * -271159611 == var15.field5396 * -530122905) {
                        var17 = var7 * 2122110429 * var15.field5395 / class740.field7814 + var1;
                        var18 = var2 + (class740.field7815 - var15.field5398 * -372920341) * var8 / class740.field7815;
                        var0.method4833(var17 - 2, var18 - 2, 4, 4, var14 << 24 | 16776960, (byte)7);
                     } else if (-1 != -484575331 * class740.field3204 && -804513353 * var16.field3532 == class740.field3204 * -484575331) {
                        var17 = var1 + 2122110429 * var15.field5395 * var7 / class740.field7814;
                        var18 = var8 * (class740.field7815 - var15.field5398 * -372920341) / class740.field7815 + var2;
                        var0.method4833(var17 - 2, var18 - 2, 4, 4, var14 << 24 | 16776960, (byte)7);
                     }
                  }
               }
   ...
   public static class262 method3087(int var0, int var1, int var2) {
      try {
         ...
         var3.field8179 = -1780317135;
         var3.field8180 = 599015853;
         var3.field8181 = (1 + var0 + 5) * -2121339651;
         var3.field8182 = (5 + var1 + 1) * -1973125931;
         var3.field8183 = new int[843157589 * var3.field8181][var3.field8182 * -16196483];
