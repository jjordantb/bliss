public class class551 extends class304 {
   ...
   public void method2386() {
      class949.field3322[812968099 * this.field506].method6637((byte)46);
   }

   public void method2383(int var1) {
      try {
         class949.field3322[812968099 * this.field506].method6637((byte)15);
      } catch (RuntimeException var3) {
         throw class158.method3445(var3, "xb.f(" + ')');
      }
   }

   class551(class907 var1) {
      super(var1);
      this.field506 = var1.method6374() * -1614214389;
   }

   public void method2385() {
      class949.field3322[812968099 * this.field506].method6637((byte)66);
   }
   ...
   public static void method434(int var0, int var1, int var2, int var3, int var4, int var5) {
      try {
         ...
         } else if (var0 - var2 >= class465.field1416 * -1424479739 && var0 + var2 <= class465.field1413 * 1135094847 && var1 - var3 >= class465.field1414 * 1155384281 && var1 + var3 <= -1062447355 * class465.field1415) {
