public class class418 {
    ...
    int field9566 = 0;
    int field9567 = -1;
    RegionOffset field9569 = new RegionOffset(-50.0F, -60.0F, -50.0F);
    class5 field9570;
    class5 field9571;
    class5 field9572;
    ...
    void method5667(byte var1) {
        try {
            ...
            this.field9564.method4872(this.field9571.field4936, this.field9571.field4934, this.field9571.field4940, (float) ((int) this.field9569.offsetX << 2), (float) ((int) this.field9569.field5300 << 2), (float) ((int) this.field9569.offsetY << 2));
