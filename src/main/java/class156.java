public class class156 extends Animable {
   ...
   class192 method2201(class848 var1, int var2) {
      try {
         ...
         if (this.field6583 != null) {
            ...
            class190 var6 = super.field3638.field3861[super.field3639][(int)var5.field7637.field5296 >> 9][(int)var5.field7637.field5299 >> 9];
   ...
   class156(class545 var1, class669 var2, int var3, int var4, int var5, int var6, int var7) {
