...
public abstract class class348 {
   ...
   static final void method189(class744 var0, int var1) {
      try {
         ...
         } else if (class730.field2924 * 1131012101 == 1) {
            var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = -1;
         } else {
            var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = class730.field2923 * -1054937867;
         }
   ...
   static final void method191(class744 var0, int var1) {
      try {
         ...
         class730.field2910 = (short)var0.field3161[var0.field3156 * 681479919];
         if (class730.field2910 <= 0) {
            class730.field2910 = 256;
         }

         class730.field2911 = (short)var0.field3161[681479919 * var0.field3156 + 1];
