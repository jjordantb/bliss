public class class611 extends class535 {
   ...
   public void method5152(int var1) {
      try {
         if (this.field3708 * -1598873795 < 0 || -1598873795 * this.field3708 > 2) {
            this.field3708 = this.method2272(-857466843) * 1886334997;
         }
         ...
         for(int var8 = 0; var8 < Client.field2684 * -1230451913; ++var8) {
            ...
            if (var9 != null) {
               ...
               if (var10.method1241(1140952765) && class923.field10295.field3639 == var10.field3639) {
                  class401 var11 = var10.field1637;
                  ...
                  if (var11 != null && var11.field9884 && var11.field9899) {
                     class32 var12 = var10.method1511().field7637;
                     int var13 = (int)var12.field5296 / 128 - var1 / 128;
                     int var14 = (int)var12.field5299 / 128 - var2 / 128;
                     if (-1 != -1362115471 * var11.field9922) {
                        class794.method468(var0, var4, var3, var5, var6, var13, var14, -1362115471 * var11.field9922, (byte)0);
                     } else {
