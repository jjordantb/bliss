public class Player extends Actor {
    ...
    public Player(SceneGraph var1, int var2) {
        super(var1, var2);
    }

    public Player(SceneGraph var1) {
        super(var1);
    }
    ...
    public final void method1990(InputStream var1, byte var2) {
        try {
            ...
            RegionOffset var9 = RegionOffset.translate(this.getRegion().regionOffset);
            var9.offsetX += (float) (this.method2550() - var6 << 8);
            var9.offsetY += (float) (this.method2550() - var6 << 8);
            ...
            if (var16 != var10) {
                var9 = RegionOffset.translate(this.getRegion().regionOffset);
                var9.offsetX = (float) ((super.field4085[0] << 9) + (this.method2550() << 8));
                var9.offsetY = (float) ((super.field4055[0] << 9) + (this.method2550() << 8));
                this.method1514(var9);
                var9.method3291();
            }
                        ...
                        if (var25 != null && var25.field10284 != -1) {
                            ...
                            if (var25.field10287 == 1) {
                                ...
                                if (var27 != null) {
                                    ...
                                    RegionOffset var13 = RegionOffset.method3296(var30.getRegion().regionOffset, class923.local.getRegion().regionOffset);
                                    var14 = (int) var13.offsetX;
                                    int var15 = (int) var13.offsetY;
                                    this.method1991(var1, var3, super.field4046[0], (long) var14, (long) var15, var25.field10284, 92160000L);
                                }
                            }

                            if (2 == var25.field10287) {
                                RegionOffset var28 = class923.local.getRegion().regionOffset;
                                long var16 = (long) (var25.field10281 - (int) var28.offsetX);
                                long var18 = (long) (var25.field10282 - (int) var28.offsetY);
                            ...
                            if (10 == var25.field10287 && var25.field10277 >= 0 && var25.field10277 < class730.loaded.length) {
                                ...
                                if (var29 != null) {
                                    RegionOffset var31 = RegionOffset.method3296(var29.getRegion().regionOffset, class923.local.getRegion().regionOffset);
                                    int var32 = (int) var31.offsetX;
                                    var14 = (int) var31.offsetY;
    ...
    public void method1995(int var1, int var2, int var3) {
        try {
            ...
            RegionOffset var5 = RegionOffset.translate(this.getRegion().regionOffset);
            var5.offsetX = (float) (256 * var4 + super.field4085[0] * 512);
            var5.offsetY = (float) (var4 * 256 + super.field4055[0] * 512);
    ...
    void method2164(class848 var1, int var2) {
        try {
            if (this.field3388 != null && (super.field4092 || this.method1992(var1, 0, (byte) 34))) {
                class135 var3 = var1.method5048();
                var3.method1008(this.getRegion());
