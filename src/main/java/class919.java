...
public class class919 {
   ...
   public class919(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      this.field10426 = 614121861 * var1;
      this.field10425 = -885436027 * var2;
      this.field10427 = var3 * 399458545;
      this.field10428 = var4 * -2122084815;
      this.field10429 = 1507836083 * var5;
      this.field10430 = var6 * -1927451111;
      this.field10432 = -875460563 * var7;
   }

   public boolean method6484(class919 var1, byte var2) {
      try {
         return var1.field10426 * -1212608691 == -1212608691 * this.field10426 && 1996750669 * var1.field10425 == this.field10425 * 1996750669 && this.field10427 * -1475891183 == -1475891183 * var1.field10427 && this.field10428 * -1761932591 == var1.field10428 * -1761932591 && this.field10429 * -28774789 == -28774789 * var1.field10429 && 484707881 * this.field10430 == 484707881 * var1.field10430 && var1.field10432 * -1637742683 == this.field10432 * -1637742683;
   ...
   static void method6486(int var0, int var1) {
      try {
         if (Loader.field6962 && 136 != class881.field10140 * -122629167) {
            if (Loader.field6962 && 264 == class881.field10140 * -122629167) {
               class881.field10143 = var0 * -1653306319;
            }
         } else {
            class881.field10164 = var0 * -1674285757;
         }
