public class IterableSceneEntity { //398
    ...
    static final void method3540(long var0) {
        try {
            ...
            RegionOffset var4 = class923.local.getRegion().regionOffset;
            RegionBase.method1154(class923.local.field3639, var3 + (int) var4.offsetX, (int) var4.offsetY + var3, class730.field2943, (short) 8192);
