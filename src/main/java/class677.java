...
public class class677 {
   ...
   int method4225(class415 var1, int var2) {
      try {
         ...
         for(int var4 = 0; var4 < 1223397457 * this.field7463; ++var4) {
            class865 var5 = this.method4224(var4, 245040087);
            if (var5.method5325(var1, -1717639697)) {
               var3 += var5.field8991 * 1646094589;
            }
         }
   ...
   public class677(class469 var1, class423 var2, class180 var3, boolean var4) {
      ...
      if (this.field7464 != null) {
         this.field7463 = this.field7464.method3286(-1006924897 * class981.field3251.field3271, -941078932) * 70760625;
      } else {
         this.field7463 = 0;
      }

      if (var4) {
         this.field7462 = new class865[1223397457 * this.field7463];

         for(int var5 = 0; var5 < this.field7463 * 1223397457; ++var5) {
            class180 var6 = this.field7464;
            byte[] var7;
            synchronized(this.field7464) {
               var7 = this.field7464.method3285(class981.field3251.field3271 * -1006924897, var5, (byte)-67);
            }

            class865 var9 = new class865();
            if (var7 != null) {
               var9.method5321(new class907(var7), -1666342024);
            }
