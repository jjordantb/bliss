public class class93 implements class297 {
    ...
    void method515(SceneGraphLevel var1, int var2, int var3) {
        this.v(this.field583, ((class204) var1).field7635, var2, var3);
    }

    native void v(long var1, long var3, int var5, int var6);

    void method516(SceneGraphLevel var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean[][] var9) {
