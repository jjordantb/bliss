   ...
   class891 method2899() {
      if (this.field7121 == null) {
         ...
         for(var4 = 0; var4 < 6; ++var4) {
            if (!var1.method4621(field7128[var4], (short)4664)) {
               return null;
            }

            class414 var5 = var1.method4625(field7128[var4], 1025120075);
         ...
         for(var4 = 0; var4 < 6; ++var4) {
            field7120[var4] = var1.method4622(field7128[var4], 1.0F, var3, var3, false, 1504533027);
         }
