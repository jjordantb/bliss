public class class864 extends class168 {
    ...
    public class864(SceneGraph var1, int var2, int var3, int var4, int var5, int var6) {
    ...
    class192 method2201(class848 var1, int var2) {
        try {
            RegionOffset var3 = RegionOffset.translate(this.getRegion().regionOffset);
            IterableSceneEntity var4 = super.field3638.method2430(super.field3639, (int) var3.offsetX >> 9, (int) var3.offsetY >> 9, -583169676);
            class824 var5 = super.field3638.method2452(super.field3639, (int) var3.offsetX >> 9, (int) var3.offsetY >> 9, (byte) 55);
            int var6 = 0;
            if (var4 != null && var4.animable.field8300) {
                var6 = var4.animable.method2168(1951240662);
            }
            ...
            if (this.field9011 == 0) {
                ...
                boolean var9 = false;
                boolean var10 = false;
                SceneGraphLevel var11 = super.field3638.field3862[super.field3640];
                int var12 = this.field9018 << 1;
                int var14 = -var12 / 2;
                int var15 = -var12 / 2;
                int var16 = var11.method3887(var14 + (int) var3.offsetX, (int) var3.offsetY + var15, -1982900642);
                int var17 = var12 / 2;
                int var18 = -var12 / 2;
                int var19 = var11.method3887((int) var3.offsetX + var17, var18 + (int) var3.offsetY, -1725399320);
                int var20 = -var12 / 2;
                int var21 = var12 / 2;
                int var22 = var11.method3887((int) var3.offsetX + var20, (int) var3.offsetY + var21, -1471266970);
                int var23 = var12 / 2;
                int var24 = var12 / 2;
                int var25 = var11.method3887(var23 + (int) var3.offsetX, var24 + (int) var3.offsetY, -1424760570);
            ...
            var3.method3291();
            RegionOffset var32 = this.getRegion().regionOffset;
            var7.method1018(var32.offsetX, var32.field5300 - 10.0F, var32.offsetY);
    ...
    boolean method2157(class848 var1, int var2, int var3, byte var4) {
        try {
            ...
            var5.method1008(this.getRegion());
