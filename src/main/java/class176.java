public class class176 {
    ...
    static int method3169(Npc var0, int var1) {
        try {
            NpcDefinition var2 = var0.field1637;
            ...
            int var5 = var0.passiveAnimator.method2779(1966806311);
    ...
    static int method3172(byte var0) {
        try {
            ...
            if (class431.field7487 == class776.field3728) {
                ...
                RegionBase.field1524 = class381.method1065(class200.field7745, false, 1, false, 1414942231);
            ...
            if (class431.field7489 == class776.field3728) {
                if (NodeTable.field4931.field9526 != -1 && !RegionBase.field1524.method3260(NodeTable.field4931.field9526, 0, -1803759646)) {
                    return 99;
                }
                ...
                class85.field1121 = new class58(class730.field2926, class321.field1066, true, class452.field7216, class452.field7215, RegionBase.field1524);
                ...
                class635.field9823 = new class382(class730.field2926, class321.field1066, class831.field9108, RegionBase.field1524);
                ...
                class571.method29(class120.field2292, RegionBase.field1524, class562.field827, class526.field3666, 995134055);
                ...
                class625.method5826(RegionBase.field1524, class962.field3627, 2043056803);
    ...
    void method3161(InputStream var1, byte var2) {
        try {
            while (true) {
    ...
    void method3162(InputStream var1, int var2, short var3) {
        try {
            if (1 == var2) {
