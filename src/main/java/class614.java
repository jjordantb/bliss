...
public class class614 {
   ...
   public class614(class389 var1, int var2, int var3, int var4) {
      this.field8887 = var1;
      this.field8885 = 1975331269 * var2;
      this.field8886 = var4 * -1576240641;
   }
   ...
   public class265 method5186(int var1) {
      try {
         ...
         if (var2 == null) {
            ...
            return var2.method4551((byte)42) != -1949334017 * this.field8886 ? null : var2;
         }
      } catch (RuntimeException var3) {
   ...
   static final void method5188(class564 var0, class131 var1, class744 var2, byte var3) {
      try {
         ...
         var0.field883 = var2.field3161[var2.field3156 * 681479919] * 349940087;
         var0.field967 = var2.field3161[1 + 681479919 * var2.field3156] * 153098785;
   ...
   static final void method5189(class744 var0, int var1) {
      try {
         var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = class740.field3209 ? 1 : 0;
      } catch (RuntimeException var3) {
   ...
   static final void method5190(class744 var0, int var1) {
      try {
         var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = class615.field8903.field9147.method5182(-192114923);
      } catch (RuntimeException var3) {
      ...
      try {
         if (var3 == 0) {
            ...
            for(int var8 = 0; var8 < var6.length; ++var8) {
               if (var1 == var6[var8].field2325 * 28445523 && 262154323 * var6[var8].field2327 == var2 && (var4 == 0 || 1126617439 * var6[var8].field2324 == var4) && (!var7 || -1087459453 * var6[var8].field2326 > var3)) {
                  var3 = -1087459453 * var6[var8].field2326;
                  var7 = true;
               }
            }
   ...
   static final void method5194(class744 var0, int var1) {
      try {
         boolean var2 = var0.field3161[(var0.field3156 -= -391880689) * 681479919] != 0;
         int var3 = var0.field3161[(var0.field3156 -= -391880689) * 681479919];
         var0.field3157[(var0.field3158 += 969361751) * -203050393 - 1] = class540.method2464((long)var3, 0, var2, class321.field1066, (short)25477);
