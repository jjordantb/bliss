...
public class class614 {
    ...
    int field8885;
    int field8886;
    RegionBase field8887;

    public class614(RegionBase var1, int var2, int var3, int var4) {
        this.field8887 = var1;
        this.field8885 = var2;
        this.field8886 = var4;
    }
    ...
    class265 method5187(int var1) {
        try {
            ...
            int var4 = this.field8887.baseX - var3.baseX;
            int var5 = this.field8887.baseY - var3.baseY;
