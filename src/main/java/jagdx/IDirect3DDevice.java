...
public final class IDirect3DDevice extends IUnknown {
   ...
   public static native long CreateAdditionalSwapChain(long var0, B var2);
   ...
   public static int a(long var0, int var2, float var3) {
      return SetRenderStatef(var0, var2, var3);
   }

   public static int f(long var0, int var2, boolean var3) {
   ...
   public static native int Reset(long var0, B var2);
