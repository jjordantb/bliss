public class class379 {
   ...
   static final void method961(class744 var0, int var1) {
      try {
         ...
         if (var6.field9176 == var2 && var6.field9171 == var3) {
            if (var3 == 115) {
               var0.field3157[(var0.field3158 += 969361751) * -203050393 - 1] = var6.method5423(var5, (byte)60);
            } else {
               var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = var6.method5426(var5, 2053522267);
            }
   ...
   static final void method962(class744 var0, int var1) {
      try {
         var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = class615.field8903.field9109.method6159((byte)45);
   ...
   static final void method963(class744 var0, int var1) {
      try {
         int var2 = var0.field3161[(var0.field3156 -= -391880689) * 681479919];
         var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = class615.field8903.field9124.method2273(var2, 1352882135);
      } catch (RuntimeException var3) {
      ...
      try {
         ...
         if (-1 != var2) {
            ...
            if (var10.method2380(1883696427)) {
               ...
               var8 = -388931549 * var10.field3822;
            }
         }

         int var16 = 0;

         for(int var11 = 0; var11 < class85.field1121.field2328 * -888767613; ++var11) {
            class518 var12 = class85.field1121.method1569(var11, true);
            if ((!var1 || var12.field4252) && -1 == var12.field4273 * -1673957995 && -1 == 465190555 * var12.field4236 && 2083650097 * var12.field4288 == -1) {
               if (935029595 * var12.field4283 != 0) {
                  if (var6 == 8221) {
                     return;
                  }
               } else if (var12.field4224.toLowerCase().indexOf(var0) == -1) {
                  if (var6 == 8221) {
         ...
         class198.field7051 = var16 * 140296601;
         String[] var17 = new String[367592105 * class198.field7051];

         for(int var18 = 0; var18 < 367592105 * class198.field7051; ++var18) {
            var17[var18] = class85.field1121.method1566(var7[var18]).field4224;
         }
   ...
   static final void method966(class744 var0, byte var1) {
      try {
         var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = class673.method4261((byte)-27) ? 1 : 0;
      } catch (RuntimeException var3) {
   ...
   static final void method967(class744 var0, int var1) {
      try {
         ...
         if (var2 != null) {
            boolean var3 = var2.method5(class491.field7820 + 1196508279 * class896.field9358, 1882038855 * class747.field4148 + class491.field7813, class384.field1429, -1054516511);
            if (var3) {
