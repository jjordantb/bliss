    ...
    static final void method4664(Actor var0, boolean var1, int var2) {
        try {
            ...
            if (var0.field4059 > class730.field2866) {
                ...
                RegionBase.method1151(var0, var1, 365613015);
                var3 = SceneGraph.field3910;
                var4 = class488.field8423;
            }

            RegionOffset var5 = var0.getRegion().regionOffset;
            int var6;
            if ((int) var5.offsetX < 512 || (int) var5.offsetY < 512 || (int) var5.offsetX >= (class730.field2697.method5271(-2045914503) - 1) * 512 || (int) var5.offsetY >= (class730.field2697.method5272(2070989013) - 1) * 512) {
            ...
            if (class923.local == var0 && ((int) var5.offsetX < 6144 || (int) var5.offsetY < 6144 || (int) var5.offsetX >= (class730.field2697.method5271(-2000317727) - 12) * 512 || (int) var5.offsetY >= (class730.field2697.method5272(52673101) - 12) * 512)) {
