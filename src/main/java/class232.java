...
public class class232 implements class54 {
   ...
   public boolean method1539() {
      return this.field8263.method3280(791455531 * this.field8264.field10423, -457216440);
   }
   ...
   public void method1543(boolean var1, byte var2) {
      try {
         if (var1) {
            int var3 = class759.field4331 * -2110394505 > Client.field2775 * 775068819 ? class759.field4331 * -2110394505 : 775068819 * Client.field2775;
            int var4 = class97.field614 * -1111710645 > -791746413 * Client.field2784 ? class97.field614 * -1111710645 : Client.field2784 * -791746413;
   ...
   public void method1540() {
      this.field8265 = class611.method5156(this.field8263, this.field8264.field10423 * 791455531, (byte)-99);
   }

   public void method1538(int var1) {
      try {
         this.field8265 = class611.method5156(this.field8263, this.field8264.field10423 * 791455531, (byte)-105);
      } catch (RuntimeException var3) {
   ...
   public void method1541(boolean var1) {
      if (var1) {
         int var2 = class759.field4331 * -2110394505 > Client.field2775 * 775068819 ? class759.field4331 * -2110394505 : 775068819 * Client.field2775;
         int var3 = class97.field614 * -1111710645 > -791746413 * Client.field2784 ? class97.field614 * -1111710645 : Client.field2784 * -791746413;
         int var4 = this.field8265.method5594();
         int var5 = this.field8265.method3109();
         int var6 = 0;
         int var7 = var2;
         ...
         this.field8265.method3116(var6, var9, var7, var8);
      }
   ...
   static final void method4660(class564 var0, class131 var1, class744 var2, int var3) {
      try {
         var0.field942 = var2.field3161[(var2.field3156 -= -391880689) * 681479919] * -1455284437;
   ...
   static final void method4661(class564 var0, class744 var1, int var2) {
      try {
         ...
         if (1548853569 * var0.field909 != 6) {
            throw new RuntimeException("");
         } else {
            class401 var5 = class258.field7913.method12(572201537 * var0.field876, -1577596397);
            if (var0.field1032 == null) {
               var0.field1032 = new class692(var5, true);
            }

            var0.field1032.field7133 = class390.method3422(1726426173) * 3177550440302969639L;
   ...
   static final void method4662(class744 var0, byte var1) {
      try {
         var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = class923.field10295.field3388 != null && class923.field10295.field3388.field2447 ? 1 : 0;
      } catch (RuntimeException var3) {
   ...
   static final void method4664(class746 var0, boolean var1, int var2) {
      try {
         int var3 = class647.field9231.field9230;
         int var4 = 0;
         if (-412225079 * var0.field4059 > Client.field2866 * 443738891) {
            class84.method942(var0, -455530754);
         } else if (var0.field4067 * 1450943713 >= Client.field2866 * 443738891) {
            class154.method3487(var0, -1562807680);
         } else {
            class389.method1151(var0, var1, 365613015);
            var3 = class545.field3910 * -2143152965;
            var4 = class488.field8423 * 236175727;
         }

         class32 var5 = var0.method1511().field7637;
         int var6;
         if ((int)var5.field5296 < 512 || (int)var5.field5299 < 512 || (int)var5.field5296 >= (Client.field2697.method5271(-2045914503) - 1) * 512 || (int)var5.field5299 >= (Client.field2697.method5272(2070989013) - 1) * 512) {
            var0.field4042.method2777(-1, -1660674133);

            for(var6 = 0; var6 < var0.field4040.length; ++var6) {
               var0.field4040[var6].field10341 = -1313669563;
         ...
         if (class923.field10295 == var0 && ((int)var5.field5296 < 6144 || (int)var5.field5299 < 6144 || (int)var5.field5296 >= (Client.field2697.method5271(-2000317727) - 12) * 512 || (int)var5.field5299 >= (Client.field2697.method5272(52673101) - 12) * 512)) {
            var0.field4042.method2777(-1, -1994577841);
