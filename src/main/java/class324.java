public class class324 extends class834 {
   ...
   boolean method531(int var1) throws class934 {
      try {
         this.field622 = this.field9169.method556("Particle");
   ...
   public void method5412(class344 var1) {
      try {
         ...
         this.field618.method271(this.field9169.field695);
      } catch (RuntimeException var3) {
   ...
   public void method5420() {
      this.method532(1482129308);
      this.field9169.method648();
   }
   ...
   public void method5415(class344 var1) {
      this.field618.method269(var1);
      this.field618.method271(this.field9169.field695);
   }

   public void method5414(class344 var1) {
      this.field618.method269(var1);
      this.field618.method271(this.field9169.field695);
   }
   ...
   void method532(int var1) {
      try {
         ...
         this.field622.method4067(this.field617, 0, this.field9166, -1031634630);
         this.field622.method4094(this.field619, this.field618, 600012267);
         this.field622.method4063(this.field620, this.field9168, (byte)67);
         this.field622.method4089(this.field616, this.field9167, 1962930050);
      } catch (RuntimeException var3) {
         throw class158.method3445(var3, "yx.h(" + ')');
      }
   }

   public void method5418(class344 var1) {
      this.field618.method269(var1);
      this.field618.method271(this.field9169.field695);
   }

   public void method5417(int var1) {
      this.method532(-1540213232);
      this.field9169.method651(class427.field7386, 0, 4 * var1, 0, 2 * var1);
   }

   public void method5409(int var1) {
      this.method532(451467459);
      this.field9169.method651(class427.field7386, 0, 4 * var1, 0, 2 * var1);
   }

   public void method5413(int var1) {
      this.method532(1059849924);
      this.field9169.method651(class427.field7386, 0, 4 * var1, 0, 2 * var1);
   }

   public void method5419() {
      this.method532(303915893);
      this.field9169.method648();
   }

   public void method5408(class344 var1) {
      this.field618.method269(var1);
      this.field618.method271(this.field9169.field695);
   }

   public void method5421() {
      this.method532(-268292083);
      this.field9169.method648();
   }

   public void method5422() {
      this.method532(-1254303888);
      this.field9169.method648();
   }
   ...
   public void method5416(int var1) {
      this.method532(1296040438);
      this.field9169.method651(class427.field7386, 0, 4 * var1, 0, 2 * var1);
   }
}
