public class class5 {
    ...
    public void method2951(InputStream var1, class418 var2, short var3) {
        try {
            ...
            if ((var4 & 16) != 0) {
                this.field4932 = RegionOffset.method3289((float) var1.method6367(2126608204), (float) var1.method6367(1708860776), (float) var1.method6367(1771057202));
            } else {
                this.field4932 = RegionOffset.method3289(-50.0F, -60.0F, -50.0F);
            }
