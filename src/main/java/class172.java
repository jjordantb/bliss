public class class172 extends class347 {
    ...
    static final void method3030(Widget var0, WidgetContainer var1, class744 var2, int var3) {
        try {
    ...
    void method3020(short var1) {
        try {
            int var2;
            if (this.field4981 > 0) {
                this.field4977 = new short[this.field4984];
                this.field4978 = new short[this.field4984];

                for (var2 = 0; var2 < this.field4984; ++var2) {
                    this.field4977[var2] = (short) ((int) (Math.pow((double) ((float) this.field4981 / 4096.0F), (double) var2) * 4096.0D));
                    this.field4978[var2] = (short) ((int) Math.pow(2.0D, (double) var2));
                }
            } else if (this.field4977 != null && this.field4984 == this.field4977.length) {
                this.field4978 = new short[this.field4984];
        ...
        try {
            switch (var1) {
                case 0:
                    ...
                    break;
                case 1:
                    this.field4984 = var2.method6371();
                    break;
                case 2:
                    this.field4981 = var2.method6367(1683252364);
                    if (this.field4981 < 0) {
                        this.field4977 = new short[this.field4984];

                        for (int var4 = 0; var4 < this.field4984; ++var4) {
                            this.field4977[var4] = (short) var2.method6367(2045257879);
                        }
                    }
                    break;
                case 3:
                    this.field4983 = this.field4982 = var2.method6371();
                    break;
                case 4:
                    this.field4980 = var2.method6371();
                    break;
                case 5:
                    this.field4983 = var2.method6371();
                    break;
                case 6:
                    this.field4982 = var2.method6371();
            }
    ...
    void method3022(int var1, int[] var2, int var3) {
        try {
            int var4 = this.field4982 * class322.field836[var1];
            short var5;
            int var6;
            int var7;
            int var8;
            ...
            if (this.field4984 == 1) {
                ...
                var7 = var6 * this.field4982 >> 12;
                var8 = var6 * this.field4983 >> 12;
                var9 = var4 * var6 >> 12;
                var10 = var9 >> 12;
                var11 = 1 + var10;
                if (var11 >= var7) {
                ...
                if (this.field4985) {
                    for (var15 = 0; var15 < class322.field831; ++var15) {
                        var16 = this.field4983 * class322.field838[var15];
                ...
                for (var6 = 1; var6 < this.field4984; ++var6) {
                    var5 = this.field4977[var6];
                    if (var5 > 8 || var5 < -8) {
                        var7 = this.field4978[var6] << 12;
                        var8 = var7 * this.field4982 >> 12;
                        var9 = var7 * this.field4983 >> 12;
                        var10 = var7 * var4 >> 12;
                        var11 = var10 >> 12;
                        var12 = 1 + var11;
                        if (var12 >= var8) {
                        ...
                        int var18;
                        if (this.field4985 && var6 == this.field4984 - 1) {
                            for (var16 = 0; var16 < class322.field831; ++var16) {
                                var17 = class322.field838[var16] * this.field4983;
    ...
    int[] method203(int var1, int var2) {
        try {
            int[] var3 = super.field270.method3546(var1, 1918477853);
    ...
    void method205(int var1) {
        try {
            this.field4979 = class322.method813(this.field4980, (byte) -21);
            this.method3020((short) -24216);

            for (int var2 = this.field4984 - 1; var2 >= 1; --var2) {
