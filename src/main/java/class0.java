public class class0 extends Animable implements class265 {
    ...
    public class719 method2165(class848 var1, byte var2) {
        try {
            ...
            if (this.field4956 == null) {
                this.field4956 = class905.method6344((int) var3.offsetX, (int) var3.field5300, (int) var3.offsetY, this.method2989(var1, 0, 720922451), 2111696382);
            }
    ...
    public void method4556(class848 var1, int var2) {
        try {
            ...
            if (var5 != null) {
                super.field3638.method2441(var5, super.field3640, (int) var7.offsetX, (int) var7.offsetY, (boolean[]) null, 1871597287);
            }
    ...
    public void method4552(class848 var1, int var2) {
        try {
            ...
            RegionOffset var7 = this.getRegion().regionOffset;
            if (var5 != null) {
                super.field3638.method2449(var5, super.field3640, (int) var7.offsetX, (int) var7.offsetY, (boolean[]) null, -808327981);
            }
