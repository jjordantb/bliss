public class class841 extends class256 {
   ...
   public boolean method5450() {
      class437 var1 = (class437) Client.field2677.method2942((long)(119655585 * this.field9192));
      if (var1 != null) {
   ...
   public boolean method4487(int var1) {
      try {
         class437 var2 = (class437) Client.field2677.method2942((long)(119655585 * this.field9192));
         if (var2 != null) {
