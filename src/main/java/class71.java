public final class class71 {
   ...
   static void method1084(int var0) {
      try {
         if (class602.field8639 != null) {
            ...
            class431.method4254(805710735 * class514.field4319, class936.field10310 * -1370784315, class965.field2535 * 2054409059, class382.field1411 * -1855216229, (byte)2);
         }
   ...
   static final void method1085(class744 var0, int var1) {
      try {
         ...
         var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = var3.field900 * 1411971043;
   ...
   public static void method1087(int var0, class180 var1, int var2, int var3, int var4, boolean var5, class856 var6, byte var7) {
      try {
         if (var0 > 0) {
            ...
            class818.field4622 = var2 * -407545223;
            class818.field4623 = var3 * -956029523;
            class818.field4625 = null;
            class818.field4616 = var4 * -2102749749;
            class342.field294 = var5;
            class573.field105 = class818.field4614.method6560((byte)-72) / var0 * 771950311;
            if (-1503744809 * class573.field105 < 1) {
               class573.field105 = 771950311;
            }
         ...
         for(int var3 = 0; var3 < var0.length; ++var3) {
            ...
            if (var4 == null) {
               ...
               if (1 == var1 && var4.field975 != null) {
                  if (var4.field879 * -1309843523 >= 0) {
                     class564 var8 = class449.method3756(var4.field867 * -440872681, (byte)-12);
                     if (var8 == null || var8.field1017 == null || -1309843523 * var4.field879 >= var8.field1017.length || var8.field1017[-1309843523 * var4.field879] != var4) {
                        continue;
                     }
                  }
   ...
   static final void method1091(class744 var0, byte var1) {
      try {
         int var2 = var0.field3161[(var0.field3156 -= -391880689) * 681479919];
         var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = class854.method5150(var2, false, (byte)63);
      } catch (RuntimeException var3) {
