public class class214 extends Animable {
    ...
    public class214(SceneGraph var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, boolean var15, int var16) {
    ...
    public final void method3782(int var1, int var2, int var3, int var4, int var5) {
        try {
            RegionOffset var6 = RegionOffset.translate(this.getRegion().regionOffset);
            if (!this.field7146) {
                float var7 = (float) var1 - var6.offsetX;
                float var8 = (float) var2 - var6.offsetY;
                float var9 = (float) Math.sqrt((double) (var8 * var8 + var7 * var7));
                if (0.0F != var9) {
                    var6.offsetX += (float) this.field7148 * var7 / var9;
                    var6.offsetY += (float) this.field7148 * var8 / var9;
                }

                if (this.field7145) {
                    var6.field5300 = (float) (class679.method4271((int) var6.offsetX, (int) var6.offsetY, super.field3639, -1463922586) - this.field7136);
                }
            ...
            this.field7147 = (double) ((float) var1 - var6.offsetX) / var10;
            this.field7144 = (double) ((float) var2 - var6.offsetY) / var10;
    ...
    public void method3783(int var1) {
        try {
            if (!this.field7146 && this.field7137 != 0) {
                ...
                if (var2 != null) {
                    RegionOffset var15 = ((Actor) var2).getRegion().regionOffset;
                    this.method1515(var15.offsetX, (float) (class679.method4271((int) var15.offsetX, (int) var15.offsetY, super.field3639, -1098231500) - this.field7136), var15.offsetY);
                    if (this.field7135 >= 0) {
                        ...
                        if (var5 != 0 || var6 != 0) {
                            ...
                            RegionOffset var13 = RegionOffset.translate(this.getRegion().regionOffset);
                            var13.offsetX += (float) var12;
                            var13.offsetY += (float) var6;
    ...
    public final void method3784(int var1, byte var2) {
        try {
            this.field7146 = true;
            class446 var3 = new class446(this.getRegion());
            var3.regionOffset.offsetX = (float) ((double) var3.regionOffset.offsetX + this.field7147 * (double) var1);
            var3.regionOffset.offsetY = (float) ((double) var3.regionOffset.offsetY + this.field7144 * (double) var1);
            if (this.field7145) {
                var3.regionOffset.field5300 = (float) (class679.method4271((int) var3.regionOffset.offsetX, (int) var3.regionOffset.offsetY, super.field3639, -1903626222) - this.field7136);
            } else if (this.field7142 != -1) {
                var3.regionOffset.field5300 = (float) ((double) var3.regionOffset.field5300 + (double) var1 * (double) var1 * 0.5D * this.field7151 + (double) var1 * this.field7150);
                this.field7150 += (double) var1 * this.field7151;
            } else {
                var3.regionOffset.field5300 = (float) ((double) var3.regionOffset.field5300 + this.field7150 * (double) var1);
            }
    ...
    void method4691(int var1) {
        try {
            ...
            super.field8299 = super.field8297 = (short) ((int) (var2.offsetX / 512.0F));
            super.field8296 = super.field8298 = (short) ((int) (var2.offsetY / 512.0F));
        } catch (RuntimeException var3) {
