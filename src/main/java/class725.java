public final class class725 extends class568 {
   ...
   public final boolean method1737(byte var1) {
      try {
         return (-1266165749 * this.field2563 & 1) != 0;
   ...
   public final int method1738(byte var1) {
      try {
         return this.field2563 * -1266165749 >> 18 & 7;
      } catch (RuntimeException var3) {
   ...
   public final boolean method1739(int var1) {
      try {
         return (-1266165749 * this.field2563 >> 21 & 1) != 0;
      } catch (RuntimeException var3) {
   ...
   public final boolean method1740(int var1) {
      try {
         return (-1266165749 * this.field2563 >> 22 & 1) != 0;
      } catch (RuntimeException var3) {
   ...
   public final boolean method1741(int var1) {
      try {
         return (-1266165749 * this.field2563 >> 23 & 1) != 0;
      } catch (RuntimeException var3) {
   ...
   public final int method1742(byte var1) {
      try {
         return class396.method3502(this.field2563 * -1266165749, (byte)105);
      } catch (RuntimeException var3) {
   ...
   public final boolean method1743(int var1, byte var2) {
      try {
         return (-1266165749 * this.field2563 >> var1 + 1 & 1) != 0;
   ...
   public class725(int var1, int var2) {
      this.field2563 = var1 * -726797405;
      this.field2557 = -751469547 * var2;
   }

   static final void method1744(class744 var0, int var1) {
      try {
         var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = -1289394455 * class740.field3198 == 100 ? 1 : 0;
      } catch (RuntimeException var3) {
   ...
   static void method1746(class744 var0, short var1) {
      try {
         var0.field3161[681479919 * var0.field3156 - 2] = class735.field3009.method4224(var0.field3161[var0.field3156 * 681479919 - 2], 245040087).method5329(class827.field9037, var0.field3161[var0.field3156 * 681479919 - 1], 910416159) ? 1 : 0;
   ...
   public static final void method1748(int var0) {
      try {
         ...
         class881.field10143 = -988354658;
         class881.field10164 = -946395782;
