...
public class class192 {
      ...
      try {
         ...
         if (this.field7022.field3642 != null) {
            for(int var6 = 0; var6 < this.field7022.field3642.length; ++var6) {
               ...
               if (this.field7022.field3642[var6].method3926(1152678761 * this.field7024.field8233 + var2, 1804353071 * this.field7024.field8231 + var3) && this.field7022.method2157(var1, var2, var3, (byte)1)) {
                  this.field7022.field3642[var6].field7250 >>= var5;
                  return true;
               }
   ...
   static final void method3743(class744 var0, int var1) {
      try {
         ...
         var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = Character.toUpperCase((char)var2);
      } catch (RuntimeException var3) {
   ...
   static final void method3744(class744 var0, int var1) {
      try {
         ...
         if (var3.field7622 == null) {
            ...
            var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = var3.field7622.length;
         }
