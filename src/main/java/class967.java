public final class class967 {
   ...
   public static final void method1749(String var0, int var1) {
      try {
         if (var0 != null) {
            if ((-1054937867 * Client.field2923 < 200 || Client.field2788) && -1054937867 * Client.field2923 < 200) {
               String var2 = class526.method2229(var0, 554575211);
               if (var2 != null) {
                  int var3;
                  String var4;
                  String var5;
                  for(var3 = 0; var3 < Client.field2923 * -1054937867; ++var3) {
                     var4 = class526.method2229(Client.field2685[var3], 460678269);
                     ...
                     if (Client.field2927[var3] != null) {
                        var5 = class526.method2229(Client.field2927[var3], -1697709934);
                  ...
                  for(var3 = 0; var3 < -548972447 * Client.field2934; ++var3) {
                     var4 = class526.method2229(Client.field2841[var3], 629913933);
                     if (var4 != null && var4.equals(var2)) {
                     ...
                     if (Client.field2937[var3] != null) {
                        var5 = class526.method2229(Client.field2937[var3], -1007795446);
                        if (var5 != null && var5.equals(var2)) {
   ...
   public static void method1750(int var0, int var1) {
      try {
         if (var0 != Client.field2733 * -1233866115) {
            Client.field2704 = 0;
            if (var0 == 5 || 13 == var0) {
            ...
            if (19 == var0) {
               class936.method6276(8 == -1233866115 * Client.field2733 || -1233866115 * Client.field2733 == 2 || 747461259 * class6.field4931.field9533 != Client.field2822 * -257444687, -1608675861);
            }

            if (var0 == 14) {
               class470.method4593(Client.field2822 * -257444687 != class6.field4931.field9522 * 1349088077, -687019075);
            }

            if (var0 != 4 && 6 != var0) {
               if (3 == var0 || var0 == 18 && -1233866115 * Client.field2733 != 16) {
            ...
            if (class399.method3529(var0, -1178041789)) {
               Client.field2697.method5315((byte)75);
            ...
            boolean var3 = 7 == -1233866115 * Client.field2733 || class162.method3544(Client.field2733 * -1233866115, 2005988447) || class669.method4121(-1233866115 * Client.field2733, 1765230881);
            if (var2 != var3) {
               if (var2) {
            ...
            Client.field2733 = -705702187 * var0;
         }
