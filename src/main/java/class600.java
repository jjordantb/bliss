    ...
    static final void method5466(int var0, int var1, int var2, int var3, boolean var4, int var5) {
        try {
            if (class730.field2697.method5317(-1611682495) == null) {
                ...
                RegionOffset var6 = class923.local.getRegion().regionOffset;
                boolean var7 = false;
                if (3 != class730.field2705) {
                    if (!class730.field2706) {
                        var7 = true;
                    }
                } else if ((int) var6.offsetX < 0 || (int) var6.offsetX >= class730.field2697.method5271(-2116251282) * 512 || (int) var6.offsetY < 0 || (int) var6.offsetY >= class730.field2697.method5272(978326552) * 512) {
                    var7 = true;
                }
                ...
                if (var7) {
                    ...
                    ++class730.field2758;
                    if (class923.local != null && (int) var6.offsetX - (class923.local.method2550() - 1) * 256 >> 9 == class95.field601 && (int) var6.offsetY - (class923.local.method2550() - 1) * 256 >> 9 == class95.field593) {
                        class95.field601 = -1;
                        class95.field593 = -1;
                    ...
                    if (class563.field1083 == 4) {
                        ...
                        class299.method6557(class456.field7163, class679.method4271((int) var6.offsetX, (int) var6.offsetY, class899.field9552, -1979916029) - 200, class530.field3741, var8, var9, (var8 >> 3) * 3 + 600 << 2, var3, -1059521295);
