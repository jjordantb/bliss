public class class878 {
    ...
    RegionBase field9817;
    int field9818;

    public class878(RegionBase var1, int var2) {
        this.field9817 = var1;
        this.field9818 = var2;
    }
    ...
    public class864 method5918(byte var1) {
        try {
            class508 var2 = (class508) class730.field2666.method2942((long) (this.field9817.field1523 << 28 | this.field9817.baseY << 14 | this.field9817.baseX));
            if (var2 == null) {
                return null;
            } else {
                RegionBase var3 = class730.field2697.getRegionBase(681479919);
                int var4 = this.field9817.baseX - var3.baseX;
                int var5 = this.field9817.baseY - var3.baseY;
