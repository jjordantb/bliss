public class class199 extends class732 implements class265 {
    ...
    public void method4556(class848 var1, int var2) {
        try {
            ...
            if (var5 != null) {
                super.field3638.method2441(var5, super.field3640, (int) var7.offsetX, (int) var7.offsetY, (boolean[]) null, 1462465403);
            }
    ...
    public void method4552(class848 var1, int var2) {
        try {
            ...
            RegionOffset var7 = this.getRegion().regionOffset;
            if (var5 != null) {
                super.field3638.method2449(var5, super.field3640, (int) var7.offsetX, (int) var7.offsetY, (boolean[]) null, -1121841328);
            }
    ...
    class486 method3746(class848 var1, int var2, boolean var3, int var4) {
        try {
            ...
            return var5.method1495(var1, var2, this.field7031, this.field7032, var6, var7, (int) var8.offsetX, (int) var8.field5300, (int) var8.offsetY, var3, (class552) null, -911505460);
