public class class637 {
   ...
   class637(int var1, float var2, float var3, int var4, int var5, int var6) {
      this.field9856 = var1 * -564629049;
      this.field9847 = var2;
      this.field9850 = var3;
      this.field9849 = var4 * 1747422061;
      this.field9846 = 1370325433 * var5;
      this.field9851 = var6 * -839233607;
   }

   class637 method5932(int var1) {
      try {
         return new class637(-1509687305 * this.field9856, this.field9847, this.field9850, -1848560027 * this.field9849, this.field9846 * -1070844791, this.field9851 * -988477815);
   ...
   void method5933(class637 var1, int var2) {
      try {
         ...
         this.field9849 = var1.field9849 * 1;
         this.field9846 = 1 * var1.field9846;
         this.field9856 = 1 * var1.field9856;
         this.field9851 = var1.field9851 * 1;
   ...
   class637(int var1) {
      this.field9856 = -564629049 * var1;
   }

   static final void method5934(class744 var0, int var1) {
      try {
         var0.field3156 -= -783761378;
         if (var0.field3161[var0.field3156 * 681479919] <= var0.field3161[1 + var0.field3156 * 681479919]) {
   ...
   public static class701 method5936(class643 var0, class246 var1, byte var2) {
      try {
         ...
         var3.field3369 = var0;
         var3.field3365 = var0.field10034 * -1035235683;
         if (-1 == var3.field3365 * 157188735) {
            var3.field3364 = new class513(260);
         } else if (var3.field3365 * 157188735 == -2) {
            var3.field3364 = new class513(10000);
         } else if (157188735 * var3.field3365 <= 18) {
            var3.field3364 = new class513(20);
         } else if (var3.field3365 * 157188735 <= 98) {
         ...
         var3.field3364.method2651(var3.field3369.field10018 * -1687656101, (byte)-23);
         var3.field3367 = 0;
         return var3;
      } catch (RuntimeException var4) {
         throw class158.method3445(var4, "as.f(" + ')');
   ...
   static final void method5938(class744 var0, int var1) {
      try {
         ...
         String var4 = (String)var0.field3157[(var0.field3158 -= 969361751) * -203050393];
         if (99 == var2) {
