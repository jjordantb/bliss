...
public final class class936 {
    ...
    public static void method6276(boolean var0, int var1) {
        try {
            ...
            class923.local = new Player((SceneGraph) null);
        ...
        try {
            ...
            if (var3 == 0) {
                ...
                if (class730.loaded[var1] != null) {
                    ...
                    var11 = var9 >> 14 & 255;
                    int var12 = var9 & 255;
                    RegionBase var13 = class730.field2697.getRegionBase(681479919);
                    int var14 = (var11 << 6) + var4 - var13.baseX;
                    int var15 = (var12 << 6) + var5 - var13.baseY;
