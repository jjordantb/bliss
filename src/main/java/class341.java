...
public abstract class class341 {
   ...
   InputStream field306 = new InputStream(10);
   ...
   byte field312 = 0;
   InputStream field313 = new InputStream(6);
   ...
   static final void method249(class513 var0, int var1, int var2) {
      try {
         ...
         if (var0.field10376 != var1) {
            throw new RuntimeException(var0.field10376 + " " + var1);
         }
   ...
   static final void method254(class744 var0, int var1) {
      try {
         ...
         if (var2 == null) {
            ...
            int var3 = var2.field5393 << 28 | var2.field5395 + class491.field7820 << 14 | class491.field7813 + var2.field5398;
   ...
   static final boolean method257(class684 var0, int var1) {
      try {
         ...
         try {
            ...
            String var5 = (var0.field7770 != null ? 2075990793 * var0.field7770.field4450 * -477306055 : -1) + class822.field9050 + (var0.field7780 != null ? 2075990793 * var0.field7780.field4450 * -477306055 : -1) + class822.field9050 + (var0.field7783 != null ? 2075990793 * var0.field7783.field4450 * -477306055 : -1) + " " + var0.field7771 + class822.field9050 + (var4.field1521 + class923.local.field4085[0]) + class822.field9050 + (var4.field1522 + class923.local.field4055[0]) + " ";

            for(int var6 = 0; var6 < var0.field7771 && var6 < 50; ++var6) {
   ...
   public static void method258(byte var0) {
      try {
         ...
         if (class978.field3123 > 0) {
            --class978.field3123;
         }

         class701 var1;
         if (class730.field2744 && class978.field3123 <= 0) {
            class978.field3123 = 20;
         ...
         if (!class730.field2647) {
            ...
            int var2 = var1.field3364.field10376;
            InputStream var3 = class615.field8903.method5393(-49990428);
            var1.field3364.method6425(var3.field10375, 0, var3.field10376, (short)-16962);
            var1.field3364.method6426(var1.field3364.field10376 - var2, (byte)-113);
   ...
   static void method259(class848 var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      try {
         if ((class51.field2309 == null || class936.field10314 == null || class103.field206 == null) && class562.field827.method3280(class420.field9723, -457216440) && class562.field827.method3280(class861.field9025, -457216440) && class562.field827.method3280(class553.field519, -457216440)) {
            class922 var7 = class922.method6242(class562.field827, class861.field9025, 0);
            class936.field10314 = var0.method4982(var7, true);
            var7.method6247();
            class407.field9260 = var0.method4982(var7, true);
            class51.field2309 = var0.method4982(class922.method6242(class562.field827, class420.field9723, 0), true);
            class922 var8 = class922.method6242(class562.field827, class553.field519, 0);
   ...
   static final void method261(class744 var0, int var1) {
      try {
         ...
         if (var2 != var3 && class540.field3923 == class540.field3920) {
            if (!class552.method457(class730.field2733, (byte)33)) {
               if (var3 == 0) {
                  class58.method1581(class771.field3732, class540.field3920, 0, var2, false, -2072200222);
