...
public class class894 extends SceneGraphLevel {
    ...
    class894(class325 var1, int var2, int var3, int var4, int var5, int[][] var6, int[][] var7, int var8) {
        ...
        this.field9494 = new float[super.width + 1][super.height + 1];
        this.field9495 = new float[super.width + 1][super.height + 1];
        this.field9484 = new float[super.width + 1][super.height + 1];

        for (int var9 = 0; var9 <= super.height; ++var9) {
            for (int var10 = 0; var10 <= super.width; ++var10) {
                int var11 = super.tileHeights[var10][var9];
                ...
                if (var10 > 0 && var9 > 0 && var10 < super.width && var9 < super.height) {
    ...
    public void method3882(int var1, int var2, int[] var3, int[] var4, int[] var5, int[] var6, int[] var7, int[] var8, int[] var9, int[] var10, class919 var11, boolean var12) {
        ...
        if (var6 != null && this.field9483 == null) {
            this.field9483 = new int[super.width][super.height][];
        }

        if (var4 != null && this.field9478 == null) {
            this.field9478 = new int[super.width][super.height][];
        }
    ...
    public void method3886(int var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean[][] var8) {
        if (this.field9491 > 0) {
            ...
            for (int var14 = var5; var14 < var7; ++var14) {
                int var15 = var14 * super.width + var4;
    ...
    public void method3898() {
        if (this.field9491 > 0) {
            ...
            int var3;
            for (int var2 = 1; var2 < super.width; ++var2) {
                for (var3 = 1; var3 < super.height; ++var3) {
            ...
            int var12;
            int var13;
            for (var12 = 0; var12 < super.width; ++var12) {
                for (var13 = 0; var13 < super.height; ++var13) {
                    if (this.field9501[var12][var13] != null) {
                        ...
                        short[] var83 = this.field9474[var13 * super.width + var12] = new short[var18.length];
            ...
            for (var12 = 0; var12 < super.width; ++var12) {
                for (var13 = 0; var13 < super.height; ++var13) {
                    short[] var69 = this.field9474[var13 * super.width + var12];
                    if (var69 != null) {
                        int var72 = 0;
            ...
            WallDecoration.method2096(var73, this.field9496, (byte) -13);
            ...
            for (int var14 = var8; var14 <= var12; ++var14) {
                ...
                for (int var16 = var10; var16 <= var13; ++var16) {
                    if (var15[var16 - var11]) {
                        field9489[field9471++] = var16 * super.width + var14;
                    }
                }
            }
