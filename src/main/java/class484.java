    ...
    public void method2383(int var1) {
        try {
            ...
            if (this.field8517 >= 0) {
                ...
                RegionOffset var6 = var5.getRegion().regionOffset;
                var2 = (int) var6.offsetX;
                var3 = (int) var6.offsetY;
                var4 = var5.field3639;
            }
            ...
            if (this.field8522 >= 0) {
                ...
                RegionOffset var8 = var7.getRegion().regionOffset;
                var10 = (int) var8.offsetX;
                var11 = (int) var8.offsetY;
                if (var4 < 0) {
                    var4 = var7.field3639;
                }
            }
