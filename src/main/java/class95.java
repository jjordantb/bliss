public class class95 {
   public static int field593 = 1835291189;
   static boolean field594 = false;
   static int field595 = 0;
   static int field596 = 955770805;
   ...
   public static int field601 = 1129029761;
   ...
   static final int method525(class21 var0, int var1) {
      try {
         if (var0 == null) {
            ...
            switch(-1062992263 * var0.field5421) {
            case 3:
               return 20;
            default:
               return 12;
   ...
   static final void method526(class744 var0, int var1) {
      try {
         ...
         var0.field3161[(var0.field3156 += -391880689) * 681479919 - 1] = class942.method6333(var2, -1912416826) ? 1 : 0;
      } catch (RuntimeException var3) {
