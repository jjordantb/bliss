            ...
            if (var0.field4056 != null || var0.field4049 != null) {
                ...
                for (int var4 = 0; var4 < var0.field4056.length; ++var4) {
                    ...
                    if (-1 == var5) {
                        ...
                        boolean var6 = false;
                        boolean var7 = false;
                        RegionOffset var8 = var0.getRegion().regionOffset;
                        int var9;
                        int var12;
                        int var13;
                        if (-1073741824 == (var5 & -1073741824)) {
                            ...
                            var12 = (int) var8.offsetX - (256 + 512 * (var10 - var3.baseX));
                            var13 = (int) var8.offsetY - (256 + (var11 - var3.baseY) * 512);
                        } else {
                            RegionOffset var18;
                            if ((var5 & '耀') != 0) {
                                var9 = var5 & 32767;
                                ...
                                var18 = var16.getRegion().regionOffset;
                                var12 = (int) var8.offsetX - (int) var18.offsetX;
                                var13 = (int) var8.offsetY - (int) var18.offsetY;
                            } else {
                                ...
                                var18 = var17.getRegion().regionOffset;
                                var12 = (int) var8.offsetX - (int) var18.offsetX;
                                var13 = (int) var8.offsetY - (int) var18.offsetY;
                            }
                        }
