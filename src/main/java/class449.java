    ...
    static final void method3762(int var0, byte var1) {
        try {
            ...
            if (var2 >= 100) {
                ...
                RegionOffset var5 = class923.local.getRegion().regionOffset;
                class299.method6557(class456.field7163, class679.method4271((int) var5.offsetX, (int) var5.offsetY, class899.field9552, -1800819540) - 200, class530.field3741, var3, var4, 600 + (var3 >> 3) * 3 << 2, var0, -1059521295);
