...
public class class514 implements Iterable {
   ...
   static void method2711(class206 var0, int var1, int var2, int var3, int var4, int var5) {
      try {
         if (-1 != var0.field7086 || var0.field7075 != null) {
            int var6 = 0;
            int var7 = var0.field7092 * class615.field8903.field9148.method2717(-2144866042) >> 8;
            if (var2 > var0.field7070) {
               var6 += var2 - var0.field7070;
            } else if (var2 < var0.field7068) {
               var6 += var0.field7068 - var2;
            }

            if (var3 > var0.field7071) {
               var6 += var3 - var0.field7071;
            } else if (var3 < var0.field7066) {
               var6 += var0.field7066 - var3;
            }

            if (var0.field7073 != 0 && var6 - 256 <= var0.field7073 && class615.field8903.field9148.method2717(-2144778383) != 0 && var0.field7067 == var1) {
               var6 -= 256;
               if (var6 < 0) {
                  var6 = 0;
               }

               int var8 = var0.field7073 - var0.field7072;
               if (var8 < 0) {
                  var8 = var0.field7073;
               }

               int var9 = var7;
               int var10 = var6 - var0.field7072;
               if (var10 > 0 && var8 > 0) {
                  var9 = (var8 - var10) * var7 / var8;
               }

               class923.local.method2550();
               int var11 = 8192;
               int var12 = (var0.field7068 + var0.field7070) / 2 - var2;
               int var13 = (var0.field7071 + var0.field7066) / 2 - var3;
               if (var12 != 0 || var13 != 0) {
                  int var14 = -class232.field8266 - (int)(Math.atan2((double)var12, (double)var13) * 2607.5945876176133D) - 4096 & 16383;
                  if (var14 > 8192) {
                     var14 = 16384 - var14;
                  }
               ...
               if (var0.field7090 == null) {
                  if (var0.field7086 >= 0) {
                     var12 = var0.field7095 == 256 && var0.field7084 == 256 ? 256 : Animation.method3569(var0.field7084, var0.field7095, -1122963701);
                     if (var0.field7087) {
                        if (var0.field7088 == null) {
                           var0.field7088 = class29.method3510(class967.field2604, var0.field7086);
                        }
                        ...
                        var19 = class624.method5837(class783.field3963, var0.field7086, 0);
                        if (var19 != null) {
               ...
               if (var0.field7069 == null) {
                  if (var0.field7075 != null && (var0.field7097 -= var4) <= 0) {
                     var12 = var0.field7095 == 256 && 256 == var0.field7084 ? 256 : (int)(Math.random() * (double)(var0.field7095 - var0.field7084)) + var0.field7084;
                     if (var0.field7094) {
                        ...
                        if (var0.field7063 != null) {
                           ...
                           if (var0.field7096 != null) {
                              ...
                              var0.field7097 = var0.field7093 + (int)(Math.random() * (double)(var0.field7065 - var0.field7093));
                           }
                        }
                     } else {
                        var13 = (int)(Math.random() * (double)var0.field7075.length);
